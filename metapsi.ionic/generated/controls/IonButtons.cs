...
public static partial class IonButtonsControl
{
    ...
    {
        return b.IonicTag("ion-buttons", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-buttons" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("collapse"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("collapse"), collapse);
    }
}
public static partial class IonButtonsExtensions
{

    /// <summary>
    /// If true, buttons will disappear when its parent toolbar has fully collapsed if the toolbar is not the first toolbar. If the toolbar is the first toolbar, the buttons will be hidden and will only be shown once all toolbars have fully collapsed.  Only applies in `ios` mode with `collapse` set to `true` on `ion-header`.  Typically used for [Collapsible Large Titles](https://ionicframework.com/docs/api/title#collapsible-large-titles)
    /// </summary>
    public static void SetCollapse<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonButtons
    {
        b.SetProperty(b.Const("collapse"), b.Const(true));
    }
    public static void SetCollapse<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> collapse) where T: IonButtons
    {
        b.SetProperty(b.Const("collapse"), collapse);
    }
}