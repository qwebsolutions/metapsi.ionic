...
{
    /// <summary>
    /// Builds a "ion-checkbox" HTML tag
    /// </summary>
    ...
    {
        return b.IonicTag("ion-checkbox", children);
    }
    ...
    /// The value of the checkbox does not mean if it's checked or not, use the `checked` property for that.  The value of a checkbox is analogous to the value of an `&lt;input type="checkbox"&gt;`, it's only used when the checkbox participates in a native `&lt;form&gt;`.
    /// </summary>
    public static void SetValue(this Metapsi.Html.AttributesBuilder<IonCheckbox> b, string value)
    {
        b.SetAttribute("value", value);
    }
    /// <summary>
    /// Builds a virtual "ion-checkbox" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("indeterminate"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("indeterminate"), indeterminate);
    }
    ...
    /// The value of the checkbox does not mean if it's checked or not, use the `checked` property for that.  The value of a checkbox is analogous to the value of an `&lt;input type="checkbox"&gt;`, it's only used when the checkbox participates in a native `&lt;form&gt;`.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<object> value) where T: IonCheckbox
    {
    ...
    /// Emitted when the checked property has changed as a result of a user action such as a click.  This event will not emit when programmatically setting the `checked` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<CheckboxChangeEventDetail>>> action) where T: IonCheckbox
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
...
public static partial class IonCheckboxExtensions
{

    /// <summary>
    /// How to control the alignment of the checkbox and label on the cross axis. `"start"`: The label and control will appear on the left of the cross axis in LTR, and on the right side in RTL. `"center"`: The label and control will appear at the center of the cross axis in both LTR and RTL. Setting this property will change the checkbox `display` to `block`.
    /// </summary>
    public static void SetAlignmentStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("alignment"), b.Const("start"));
    }
    ...
    /// How to control the alignment of the checkbox and label on the cross axis. `"start"`: The label and control will appear on the left of the cross axis in LTR, and on the right side in RTL. `"center"`: The label and control will appear at the center of the cross axis in both LTR and RTL. Setting this property will change the checkbox `display` to `block`.
    /// </summary>
    public static void SetAlignmentCenter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("alignment"), b.Const("center"));
    }
    ...
    /// If `true`, the checkbox is selected.
    /// </summary>
    public static void SetChecked<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("checked"), b.Const(true));
    }
    public static void SetChecked<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> @checked) where T: IonCheckbox
    {
        b.SetProperty(b.Const("checked"), @checked);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonCheckbox
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// If `true`, the user cannot interact with the checkbox.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonCheckbox
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// Text that is placed under the checkbox label and displayed when an error is detected.
    /// </summary>
    public static void SetErrorText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> errorText) where T: IonCheckbox
    {
        b.SetProperty(b.Const("errorText"), errorText);
    }
    ...
    /// Text that is placed under the checkbox label and displayed when no error is detected.
    /// </summary>
    public static void SetHelperText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> helperText) where T: IonCheckbox
    {
        b.SetProperty(b.Const("helperText"), helperText);
    }
    ...
    /// If `true`, the checkbox will visually appear as indeterminate.
    /// </summary>
    public static void SetIndeterminate<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("indeterminate"), b.Const(true));
    }
    public static void SetIndeterminate<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> indeterminate) where T: IonCheckbox
    {
        b.SetProperty(b.Const("indeterminate"), indeterminate);
    }
    ...
    /// How to pack the label and checkbox within a line. `"start"`: The label and checkbox will appear on the left in LTR and on the right in RTL. `"end"`: The label and checkbox will appear on the right in LTR and on the left in RTL. `"space-between"`: The label and checkbox will appear on opposite ends of the line with space between the two elements. Setting this property will change the checkbox `display` to `block`.
    /// </summary>
    public static void SetJustifyStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("justify"), b.Const("start"));
    }
    ...
    /// How to pack the label and checkbox within a line. `"start"`: The label and checkbox will appear on the left in LTR and on the right in RTL. `"end"`: The label and checkbox will appear on the right in LTR and on the left in RTL. `"space-between"`: The label and checkbox will appear on opposite ends of the line with space between the two elements. Setting this property will change the checkbox `display` to `block`.
    /// </summary>
    public static void SetJustifyEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("justify"), b.Const("end"));
    }
    ...
    /// How to pack the label and checkbox within a line. `"start"`: The label and checkbox will appear on the left in LTR and on the right in RTL. `"end"`: The label and checkbox will appear on the right in LTR and on the left in RTL. `"space-between"`: The label and checkbox will appear on opposite ends of the line with space between the two elements. Setting this property will change the checkbox `display` to `block`.
    /// </summary>
    public static void SetJustifySpaceBetween<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("justify"), b.Const("space-between"));
    }
    ...
    /// Where to place the label relative to the checkbox. `"start"`: The label will appear to the left of the checkbox in LTR and to the right in RTL. `"end"`: The label will appear to the right of the checkbox in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the checkbox regardless of the direction. The alignment of the label can be controlled with the `alignment` property.
    /// </summary>
    public static void SetLabelPlacementStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("start"));
    }
    ...
    /// Where to place the label relative to the checkbox. `"start"`: The label will appear to the left of the checkbox in LTR and to the right in RTL. `"end"`: The label will appear to the right of the checkbox in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the checkbox regardless of the direction. The alignment of the label can be controlled with the `alignment` property.
    /// </summary>
    public static void SetLabelPlacementEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("end"));
    }
    ...
    /// Where to place the label relative to the checkbox. `"start"`: The label will appear to the left of the checkbox in LTR and to the right in RTL. `"end"`: The label will appear to the right of the checkbox in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the checkbox regardless of the direction. The alignment of the label can be controlled with the `alignment` property.
    /// </summary>
    public static void SetLabelPlacementFixed<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("fixed"));
    }
    ...
    /// Where to place the label relative to the checkbox. `"start"`: The label will appear to the left of the checkbox in LTR and to the right in RTL. `"end"`: The label will appear to the right of the checkbox in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the checkbox regardless of the direction. The alignment of the label can be controlled with the `alignment` property.
    /// </summary>
    public static void SetLabelPlacementStacked<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("stacked"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// The name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonCheckbox
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// If true, screen readers will announce it as a required field. This property works only for accessibility purposes, it will not prevent the form from submitting if the value is invalid.
    /// </summary>
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonCheckbox
    {
        b.SetProperty(b.Const("required"), b.Const(true));
    }
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> required) where T: IonCheckbox
    {
        b.SetProperty(b.Const("required"), required);
    }
    ...
    /// The value of the checkbox does not mean if it's checked or not, use the `checked` property for that.  The value of a checkbox is analogous to the value of an `&lt;input type="checkbox"&gt;`, it's only used when the checkbox participates in a native `&lt;form&gt;`.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<object> value) where T: IonCheckbox
    {
        b.SetProperty(b.Const("value"), value);
    }
}