...
public class IonContent
{
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonContent> instead")]
...
public static partial class IonContentControl
{
    ...
    {
        return b.IonicTag("ion-content", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-content" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("fixedSlotPlacement"), b.Const("after"));
    }
    ...
    {
        b.SetProperty(b.Const("fixedSlotPlacement"), b.Const("before"));
    }
    ...
    {
        b.SetProperty(b.Const("forceOverscroll"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("forceOverscroll"), forceOverscroll);
    }
    ...
    {
        b.SetProperty(b.Const("fullscreen"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("fullscreen"), fullscreen);
    }
    ...
    {
        b.SetProperty(b.Const("scrollEvents"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("scrollEvents"), scrollEvents);
    }
    ...
    {
        b.SetProperty(b.Const("onionScroll"), b.Const(action));
    }
    ...
    /// Emitted while scrolling. This event is disabled by default. Set `scrollEvents` to `true` to enable.
    /// </summary>
    public static void OnIonScroll<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<ScrollDetail>>> action) where T: IonContent
    {
        b.SetProperty(b.Const("onionScroll"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionScrollEnd"), b.Const(action));
    }
    ...
    /// Emitted when the scroll has ended. This event is disabled by default. Set `scrollEvents` to `true` to enable.
    /// </summary>
    public static void OnIonScrollEnd<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<ScrollBaseDetail>>> action) where T: IonContent
    {
        b.SetProperty(b.Const("onionScrollEnd"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionScrollStart"), b.Const(action));
    }
    ...
    /// Emitted when the scroll has started. This event is disabled by default. Set `scrollEvents` to `true` to enable.
    /// </summary>
    public static void OnIonScrollStart<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<ScrollBaseDetail>>> action) where T: IonContent
    {
        b.SetProperty(b.Const("onionScrollStart"), b.Const(action));
    }
}
public static partial class IonContentExtensions
{

    /// <summary>
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonContent
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// Controls where the fixed content is placed relative to the main content in the DOM. This can be used to control the order in which fixed elements receive keyboard focus. For example, if a FAB in the fixed slot should receive keyboard focus before the main page content, set this property to `'before'`.
    /// </summary>
    public static void SetFixedSlotPlacementAfter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("fixedSlotPlacement"), b.Const("after"));
    }
    ...
    /// Controls where the fixed content is placed relative to the main content in the DOM. This can be used to control the order in which fixed elements receive keyboard focus. For example, if a FAB in the fixed slot should receive keyboard focus before the main page content, set this property to `'before'`.
    /// </summary>
    public static void SetFixedSlotPlacementBefore<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("fixedSlotPlacement"), b.Const("before"));
    }
    ...
    /// If `true` and the content does not cause an overflow scroll, the scroll interaction will cause a bounce. If the content exceeds the bounds of ionContent, nothing will change. Note, this does not disable the system bounce on iOS. That is an OS level setting.
    /// </summary>
    public static void SetForceOverscroll<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("forceOverscroll"), b.Const(true));
    }
    public static void SetForceOverscroll<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> forceOverscroll) where T: IonContent
    {
        b.SetProperty(b.Const("forceOverscroll"), forceOverscroll);
    }
    ...
    /// If `true`, the content will scroll behind the headers and footers. This effect can easily be seen by setting the toolbar to transparent.
    /// </summary>
    public static void SetFullscreen<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("fullscreen"), b.Const(true));
    }
    public static void SetFullscreen<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> fullscreen) where T: IonContent
    {
        b.SetProperty(b.Const("fullscreen"), fullscreen);
    }
    ...
    /// Because of performance reasons, ionScroll events are disabled by default, in order to enable them and start listening from (ionScroll), set this property to `true`.
    /// </summary>
    public static void SetScrollEvents<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("scrollEvents"), b.Const(true));
    }
    public static void SetScrollEvents<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> scrollEvents) where T: IonContent
    {
        b.SetProperty(b.Const("scrollEvents"), scrollEvents);
    }
    ...
    /// If you want to enable the content scrolling in the X axis, set this property to `true`.
    /// </summary>
    public static void SetScrollX<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("scrollX"), b.Const(true));
    }
    public static void SetScrollX<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> scrollX) where T: IonContent
    {
        b.SetProperty(b.Const("scrollX"), scrollX);
    }
    ...
    /// If you want to disable the content scrolling in the Y axis, set this property to `false`.
    /// </summary>
    public static void SetScrollY<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonContent
    {
        b.SetProperty(b.Const("scrollY"), b.Const(true));
    }
    public static void SetScrollY<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> scrollY) where T: IonContent
    {
        b.SetProperty(b.Const("scrollY"), scrollY);
    }
    ...
    /// Get the element where the actual scrolling takes place. This element can be used to subscribe to `scroll` events or manually modify `scrollTop`. However, it's recommended to use the API provided by `ion-content`:  i.e. Using `ionScroll`, `ionScrollStart`, `ionScrollEnd` for scrolling events and `scrollToPoint()` to scroll the content into a certain point.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<HTMLElement>> getScrollElement(this Metapsi.Syntax.ObjBuilder<IonContent> b)
    {
        return b.Call<Promise<HTMLElement>>("getScrollElement");
    }

    /// <summary>
    /// Scroll by a specified X/Y distance in the component.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> scrollByPoint(this Metapsi.Syntax.ObjBuilder<IonContent> b, Metapsi.Syntax.Var<int> x, Metapsi.Syntax.Var<int> y, Metapsi.Syntax.Var<int> duration)
    {
        return b.Call<Promise>("scrollByPoint", x, y, duration);
    }

    /// <summary>
    /// Scroll to the bottom of the component.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> scrollToBottom(this Metapsi.Syntax.ObjBuilder<IonContent> b, Metapsi.Syntax.Var<int> duration = null)
    {
        return b.Call<Promise>("scrollToBottom", duration);
    }

    /// <summary>
    /// Scroll to a specified X/Y location in the component.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> scrollToPoint(this Metapsi.Syntax.ObjBuilder<IonContent> b, Metapsi.Syntax.Var<int> x, Metapsi.Syntax.Var<int> y, Metapsi.Syntax.Var<int> duration = null)
    {
        return b.Call<Promise>("scrollToPoint", x, y, duration);
    }

    /// <summary>
    /// Scroll to the top of the component.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> scrollToTop(this Metapsi.Syntax.ObjBuilder<IonContent> b, Metapsi.Syntax.Var<int> duration = null)
    {
        return b.Call<Promise>("scrollToTop", duration);
    }
}