...
public class IonDatetime
{
    ...
    /// </summary>
    public object dayValues { get; set; }
    ...
    /// </summary>
    public object highlightedDates { get; set; }
    ...
    /// </summary>
    public object hourValues { get; set; }
    ...
    /// </summary>
    public System.Func<string, bool> isDateEnabled { get; set; }
    ...
    /// </summary>
    public object minuteValues { get; set; }
    ...
    /// </summary>
    public object monthValues { get; set; }
    ...
    /// </summary>
    public bool showDefaultTimeLabel { get; set; }
    ...
    /// </summary>
    public System.Func<System.Collections.Generic.List<string>, string> titleSelectedDatesFormatter { get; set; }
    ...
    /// </summary>
    public object yearValues { get; set; }
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonDatetime> instead")]
...
{
    /// <summary>
    /// Builds a "ion-datetime" HTML tag
    /// </summary>
    ...
    {
        return b.IonicTag("ion-datetime", children);
    }
    ...
    /// The first day of the week to use for `ion-datetime`. The default value is `0` and represents Sunday.
    /// </summary>
    public static void SetFirstDayOfWeek(this Metapsi.Html.AttributesBuilder<IonDatetime> b, string firstDayOfWeek)
    {
    ...
    {
        if (showAdjacentDays) b.SetAttribute("show-adjacent-days", "");
    }
    ...
    {
        b.SetAttribute("show-adjacent-days", "");
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-datetime" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("cancelText"), cancelText);
    }
    ...
    {
        b.SetProperty(b.Const("clearText"), clearText);
    }
    ...
    {
        b.SetProperty(b.Const("dayValues"), dayValues);
    }
    ...
    {
        b.SetProperty(b.Const("doneText"), doneText);
    }
    ...
    {
        b.SetProperty(b.Const("firstDayOfWeek"), firstDayOfWeek);
    }

    /// <summary>
    /// Formatting options for dates and times. Should include a 'date' and/or 'time' object, each of which is of type [Intl.DateTimeFormatOptions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat/DateTimeFormat#options).
    /// </summary>
    public static void SetFormatOptions<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<FormatOptions> formatOptions) where T: IonDatetime
    {
        b.SetProperty(b.Const("formatOptions"), formatOptions);
    }

    /// <summary>
    /// Used to apply custom text and background colors to specific dates.  Can be either an array of objects containing ISO strings and colors, or a callback that receives an ISO string and returns the colors.  Only applies to the `date`, `date-time`, and `time-date` presentations, with `preferWheel="false"`.
    /// </summary>
    public static void SetHighlightedDates<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<System.Func<string, string>> highlightedDates) where T: IonDatetime
    {
        b.SetProperty(b.Const("highlightedDates"), highlightedDates);
    }
    ...
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h11"));
    }
    ...
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h12"));
    }
    ...
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h23"));
    }
    ...
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h24"));
    }
    ...
    {
        b.SetProperty(b.Const("hourValues"), hourValues);
    }
    ...
    {
        b.SetProperty(b.Const("isDateEnabled"), isDateEnabled);
    }
    ...
    {
        b.SetProperty(b.Const("locale"), locale);
    }
    ...
    {
        b.SetProperty(b.Const("minuteValues"), minuteValues);
    }
    ...
    {
        b.SetProperty(b.Const("monthValues"), monthValues);
    }
    ...
    {
        b.SetProperty(b.Const("preferWheel"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("preferWheel"), preferWheel);
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("date-time"));
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("time-date"));
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("date"));
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("time"));
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("month"));
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("year"));
    }
    ...
    {
        b.SetProperty(b.Const("presentation"), b.Const("month-year"));
    }
    ...
    {
        b.SetProperty(b.Const("showAdjacentDays"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("showAdjacentDays"), showAdjacentDays);
    }
    ...
    {
        b.SetProperty(b.Const("showClearButton"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("showClearButton"), showClearButton);
    }
    ...
    {
        b.SetProperty(b.Const("showDefaultButtons"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("showDefaultButtons"), showDefaultButtons);
    }
    ...
    {
        b.SetProperty(b.Const("showDefaultTimeLabel"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("showDefaultTimeLabel"), showDefaultTimeLabel);
    }
    ...
    {
        b.SetProperty(b.Const("showDefaultTitle"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("showDefaultTitle"), showDefaultTitle);
    }
    ...
    {
        b.SetProperty(b.Const("size"), b.Const("fixed"));
    }
    ...
    {
        b.SetProperty(b.Const("titleSelectedDatesFormatter"), titleSelectedDatesFormatter);
    }
    ...
    {
        b.SetProperty(b.Const("yearValues"), yearValues);
    }
    ...
    /// Emitted when the value (selected date) has changed.  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<DatetimeChangeEventDetail>>> action) where T: IonDatetime
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
...
public static partial class IonDatetimeExtensions
{

    /// <summary>
    /// The text to display on the picker's cancel button.
    /// </summary>
    public static void SetCancelText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> cancelText) where T: IonDatetime
    {
        b.SetProperty(b.Const("cancelText"), cancelText);
    }
    ...
    /// The text to display on the picker's "Clear" button.
    /// </summary>
    public static void SetClearText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> clearText) where T: IonDatetime
    {
        b.SetProperty(b.Const("clearText"), clearText);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, refer to [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonDatetime
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// Values used to create the list of selectable days. By default every day is shown for the given month. However, to control exactly which days of the month to display, the `dayValues` input can take a number, an array of numbers, or a string of comma separated numbers. Note that even if the array days have an invalid number for the selected month, like `31` in February, it will correctly not show days which are not valid for the selected month.
    /// </summary>
    public static void SetDayValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> dayValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("dayValues"), dayValues);
    }
    ...
    /// Values used to create the list of selectable days. By default every day is shown for the given month. However, to control exactly which days of the month to display, the `dayValues` input can take a number, an array of numbers, or a string of comma separated numbers. Note that even if the array days have an invalid number for the selected month, like `31` in February, it will correctly not show days which are not valid for the selected month.
    /// </summary>
    public static void SetDayValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> dayValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("dayValues"), dayValues);
    }
    ...
    /// Values used to create the list of selectable days. By default every day is shown for the given month. However, to control exactly which days of the month to display, the `dayValues` input can take a number, an array of numbers, or a string of comma separated numbers. Note that even if the array days have an invalid number for the selected month, like `31` in February, it will correctly not show days which are not valid for the selected month.
    /// </summary>
    public static void SetDayValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Collections.Generic.List<int>> dayValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("dayValues"), dayValues);
    }
    ...
    /// If `true`, the user cannot interact with the datetime.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonDatetime
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// The text to display on the picker's "Done" button.
    /// </summary>
    public static void SetDoneText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> doneText) where T: IonDatetime
    {
        b.SetProperty(b.Const("doneText"), doneText);
    }
    ...
    /// The first day of the week to use for `ion-datetime`. The default value is `0` and represents Sunday.
    /// </summary>
    public static void SetFirstDayOfWeek<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> firstDayOfWeek) where T: IonDatetime
    {
        b.SetProperty(b.Const("firstDayOfWeek"), firstDayOfWeek);
    }
    ...
    /// Formatting options for dates and times. Should include a 'date' and/or 'time' object, each of which is of type [Intl.DateTimeFormatOptions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/DateTimeFormat/DateTimeFormat#options).
    /// </summary>
    public static void SetFormatOptions<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<FormatOptions> formatOptions) where T: IonDatetime
    {
        b.SetProperty(b.Const("formatOptions"), formatOptions);
    }
    ...
    /// Used to apply custom text and background colors to specific dates.  Can be either an array of objects containing ISO strings and colors, or a callback that receives an ISO string and returns the colors.  Only applies to the `date`, `date-time`, and `time-date` presentations, with `preferWheel="false"`.
    /// </summary>
    public static void SetHighlightedDates<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<string, string>> highlightedDates) where T: IonDatetime
    {
        b.SetProperty(b.Const("highlightedDates"), highlightedDates);
    }
    ...
    /// The hour cycle of the `ion-datetime`. If no value is set, this is specified by the current locale.
    /// </summary>
    public static void SetHourCycleH11<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h11"));
    }
    ...
    /// The hour cycle of the `ion-datetime`. If no value is set, this is specified by the current locale.
    /// </summary>
    public static void SetHourCycleH12<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h12"));
    }
    ...
    /// The hour cycle of the `ion-datetime`. If no value is set, this is specified by the current locale.
    /// </summary>
    public static void SetHourCycleH23<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h23"));
    }
    ...
    /// The hour cycle of the `ion-datetime`. If no value is set, this is specified by the current locale.
    /// </summary>
    public static void SetHourCycleH24<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourCycle"), b.Const("h24"));
    }
    ...
    /// Values used to create the list of selectable hours. By default the hour values range from `0` to `23` for 24-hour, or `1` to `12` for 12-hour. However, to control exactly which hours to display, the `hourValues` input can take a number, an array of numbers, or a string of comma separated numbers.
    /// </summary>
    public static void SetHourValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> hourValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourValues"), hourValues);
    }
    ...
    /// Values used to create the list of selectable hours. By default the hour values range from `0` to `23` for 24-hour, or `1` to `12` for 12-hour. However, to control exactly which hours to display, the `hourValues` input can take a number, an array of numbers, or a string of comma separated numbers.
    /// </summary>
    public static void SetHourValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> hourValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourValues"), hourValues);
    }
    ...
    /// Values used to create the list of selectable hours. By default the hour values range from `0` to `23` for 24-hour, or `1` to `12` for 12-hour. However, to control exactly which hours to display, the `hourValues` input can take a number, an array of numbers, or a string of comma separated numbers.
    /// </summary>
    public static void SetHourValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Collections.Generic.List<int>> hourValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("hourValues"), hourValues);
    }
    ...
    /// Returns if an individual date (calendar day) is enabled or disabled.  If `true`, the day will be enabled/interactive. If `false`, the day will be disabled/non-interactive.  The function accepts an ISO 8601 date string of a given day. By default, all days are enabled. Developers can use this function to write custom logic to disable certain days.  The function is called for each rendered calendar day, for the previous, current and next month. Custom implementations should be optimized for performance to avoid jank.
    /// </summary>
    public static void SetIsDateEnabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<string, bool>> isDateEnabled) where T: IonDatetime
    {
        b.SetProperty(b.Const("isDateEnabled"), isDateEnabled);
    }
    ...
    /// The locale to use for `ion-datetime`. This impacts month and day name formatting. The `"default"` value refers to the default locale set by your device.
    /// </summary>
    public static void SetLocale<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> locale) where T: IonDatetime
    {
        b.SetProperty(b.Const("locale"), locale);
    }
    ...
    /// The maximum datetime allowed. Value must be a date string following the [ISO 8601 datetime format standard](https://www.w3.org/TR/NOTE-datetime), `1996-12-19`. The format does not have to be specific to an exact datetime. For example, the maximum could just be the year, such as `1994`. Defaults to the end of this year.
    /// </summary>
    public static void SetMax<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> max) where T: IonDatetime
    {
        b.SetProperty(b.Const("max"), max);
    }
    ...
    /// The minimum datetime allowed. Value must be a date string following the [ISO 8601 datetime format standard](https://www.w3.org/TR/NOTE-datetime), such as `1996-12-19`. The format does not have to be specific to an exact datetime. For example, the minimum could just be the year, such as `1994`. Defaults to the beginning of the year, 100 years ago from today.
    /// </summary>
    public static void SetMin<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> min) where T: IonDatetime
    {
        b.SetProperty(b.Const("min"), min);
    }
    ...
    /// Values used to create the list of selectable minutes. By default the minutes range from `0` to `59`. However, to control exactly which minutes to display, the `minuteValues` input can take a number, an array of numbers, or a string of comma separated numbers. For example, if the minute selections should only be every 15 minutes, then this input value would be `minuteValues="0,15,30,45"`.
    /// </summary>
    public static void SetMinuteValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> minuteValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("minuteValues"), minuteValues);
    }
    ...
    /// Values used to create the list of selectable minutes. By default the minutes range from `0` to `59`. However, to control exactly which minutes to display, the `minuteValues` input can take a number, an array of numbers, or a string of comma separated numbers. For example, if the minute selections should only be every 15 minutes, then this input value would be `minuteValues="0,15,30,45"`.
    /// </summary>
    public static void SetMinuteValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> minuteValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("minuteValues"), minuteValues);
    }
    ...
    /// Values used to create the list of selectable minutes. By default the minutes range from `0` to `59`. However, to control exactly which minutes to display, the `minuteValues` input can take a number, an array of numbers, or a string of comma separated numbers. For example, if the minute selections should only be every 15 minutes, then this input value would be `minuteValues="0,15,30,45"`.
    /// </summary>
    public static void SetMinuteValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Collections.Generic.List<int>> minuteValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("minuteValues"), minuteValues);
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// Values used to create the list of selectable months. By default the month values range from `1` to `12`. However, to control exactly which months to display, the `monthValues` input can take a number, an array of numbers, or a string of comma separated numbers. For example, if only summer months should be shown, then this input value would be `monthValues="6,7,8"`. Note that month numbers do *not* have a zero-based index, meaning January's value is `1`, and December's is `12`.
    /// </summary>
    public static void SetMonthValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> monthValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("monthValues"), monthValues);
    }
    ...
    /// Values used to create the list of selectable months. By default the month values range from `1` to `12`. However, to control exactly which months to display, the `monthValues` input can take a number, an array of numbers, or a string of comma separated numbers. For example, if only summer months should be shown, then this input value would be `monthValues="6,7,8"`. Note that month numbers do *not* have a zero-based index, meaning January's value is `1`, and December's is `12`.
    /// </summary>
    public static void SetMonthValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> monthValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("monthValues"), monthValues);
    }
    ...
    /// Values used to create the list of selectable months. By default the month values range from `1` to `12`. However, to control exactly which months to display, the `monthValues` input can take a number, an array of numbers, or a string of comma separated numbers. For example, if only summer months should be shown, then this input value would be `monthValues="6,7,8"`. Note that month numbers do *not* have a zero-based index, meaning January's value is `1`, and December's is `12`.
    /// </summary>
    public static void SetMonthValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Collections.Generic.List<int>> monthValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("monthValues"), monthValues);
    }
    ...
    /// If `true`, multiple dates can be selected at once. Only applies to `presentation="date"` and `preferWheel="false"`.
    /// </summary>
    public static void SetMultiple<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("multiple"), b.Const(true));
    }
    public static void SetMultiple<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> multiple) where T: IonDatetime
    {
        b.SetProperty(b.Const("multiple"), multiple);
    }
    ...
    /// The name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonDatetime
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// If `true`, a wheel picker will be rendered instead of a calendar grid where possible. If `false`, a calendar grid will be rendered instead of a wheel picker where possible.  A wheel picker can be rendered instead of a grid when `presentation` is one of the following values: `"date"`, `"date-time"`, or `"time-date"`.  A wheel picker will always be rendered regardless of the `preferWheel` value when `presentation` is one of the following values: `"time"`, `"month"`, `"month-year"`, or `"year"`.
    /// </summary>
    public static void SetPreferWheel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("preferWheel"), b.Const(true));
    }
    public static void SetPreferWheel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> preferWheel) where T: IonDatetime
    {
        b.SetProperty(b.Const("preferWheel"), preferWheel);
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationDateTime<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("date-time"));
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationTimeDate<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("time-date"));
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationDate<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("date"));
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationTime<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("time"));
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationMonth<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("month"));
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationYear<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("year"));
    }
    ...
    /// Which values you want to select. `"date"` will show a calendar picker to select the month, day, and year. `"time"` will show a time picker to select the hour, minute, and (optionally) AM/PM. `"date-time"` will show the date picker first and time picker second. `"time-date"` will show the time picker first and date picker second.
    /// </summary>
    public static void SetPresentationMonthYear<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("presentation"), b.Const("month-year"));
    }
    ...
    /// If `true`, the datetime appears normal but the selected date cannot be changed.
    /// </summary>
    public static void SetReadonly<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("readonly"), b.Const(true));
    }
    public static void SetReadonly<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> @readonly) where T: IonDatetime
    {
        b.SetProperty(b.Const("readonly"), @readonly);
    }
    ...
    /// If `true`, the datetime calendar displays a six-week (42-day) layout, including days from the previous and next months to fill the grid. These adjacent days are selectable unless disabled.
    /// </summary>
    public static void SetShowAdjacentDays<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("showAdjacentDays"), b.Const(true));
    }
    public static void SetShowAdjacentDays<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> showAdjacentDays) where T: IonDatetime
    {
        b.SetProperty(b.Const("showAdjacentDays"), showAdjacentDays);
    }
    ...
    /// If `true`, a "Clear" button will be rendered alongside the default "Cancel" and "OK" buttons at the bottom of the `ion-datetime` component. Developers can also use the `button` slot if they want to customize these buttons. If custom buttons are set in the `button` slot then the default buttons will not be rendered.
    /// </summary>
    public static void SetShowClearButton<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("showClearButton"), b.Const(true));
    }
    public static void SetShowClearButton<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> showClearButton) where T: IonDatetime
    {
        b.SetProperty(b.Const("showClearButton"), showClearButton);
    }
    ...
    /// If `true`, the default "Cancel" and "OK" buttons will be rendered at the bottom of the `ion-datetime` component. Developers can also use the `button` slot if they want to customize these buttons. If custom buttons are set in the `button` slot then the default buttons will not be rendered.
    /// </summary>
    public static void SetShowDefaultButtons<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("showDefaultButtons"), b.Const(true));
    }
    public static void SetShowDefaultButtons<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> showDefaultButtons) where T: IonDatetime
    {
        b.SetProperty(b.Const("showDefaultButtons"), showDefaultButtons);
    }
    ...
    /// If `true`, the default "Time" label will be rendered for the time selector of the `ion-datetime` component. Developers can also use the `time-label` slot if they want to customize this label. If a custom label is set in the `time-label` slot then the default label will not be rendered.
    /// </summary>
    public static void SetShowDefaultTimeLabel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("showDefaultTimeLabel"), b.Const(true));
    }
    public static void SetShowDefaultTimeLabel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> showDefaultTimeLabel) where T: IonDatetime
    {
        b.SetProperty(b.Const("showDefaultTimeLabel"), showDefaultTimeLabel);
    }
    ...
    /// If `true`, a header will be shown above the calendar picker. This will include both the slotted title, and the selected date.
    /// </summary>
    public static void SetShowDefaultTitle<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("showDefaultTitle"), b.Const(true));
    }
    public static void SetShowDefaultTitle<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> showDefaultTitle) where T: IonDatetime
    {
        b.SetProperty(b.Const("showDefaultTitle"), showDefaultTitle);
    }
    ...
    /// If `cover`, the `ion-datetime` will expand to cover the full width of its container. If `fixed`, the `ion-datetime` will have a fixed width.
    /// </summary>
    public static void SetSizeFixed<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("size"), b.Const("fixed"));
    }
    ...
    /// If `cover`, the `ion-datetime` will expand to cover the full width of its container. If `fixed`, the `ion-datetime` will have a fixed width.
    /// </summary>
    public static void SetSizeCover<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonDatetime
    {
        b.SetProperty(b.Const("size"), b.Const("cover"));
    }
    ...
    /// A callback used to format the header text that shows how many dates are selected. Only used if there are 0 or more than 1 selected (i.e. unused for exactly 1). By default, the header text is set to "numberOfDates days".  See https://ionicframework.com/docs/troubleshooting/runtime#accessing-this if you need to access `this` from within the callback.
    /// </summary>
    public static void SetTitleSelectedDatesFormatter<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<System.Collections.Generic.List<string>, string>> titleSelectedDatesFormatter) where T: IonDatetime
    {
        b.SetProperty(b.Const("titleSelectedDatesFormatter"), titleSelectedDatesFormatter);
    }
    ...
    /// The value of the datetime as a valid ISO 8601 datetime string. This should be an array of strings only when `multiple="true"`.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> value) where T: IonDatetime
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// The value of the datetime as a valid ISO 8601 datetime string. This should be an array of strings only when `multiple="true"`.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Collections.Generic.List<string>> value) where T: IonDatetime
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// Values used to create the list of selectable years. By default the year values range between the `min` and `max` datetime inputs. However, to control exactly which years to display, the `yearValues` input can take a number, an array of numbers, or string of comma separated numbers. For example, to show upcoming and recent leap years, then this input's value would be `yearValues="2008,2012,2016,2020,2024"`.
    /// </summary>
    public static void SetYearValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> yearValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("yearValues"), yearValues);
    }
    ...
    /// Values used to create the list of selectable years. By default the year values range between the `min` and `max` datetime inputs. However, to control exactly which years to display, the `yearValues` input can take a number, an array of numbers, or string of comma separated numbers. For example, to show upcoming and recent leap years, then this input's value would be `yearValues="2008,2012,2016,2020,2024"`.
    /// </summary>
    public static void SetYearValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> yearValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("yearValues"), yearValues);
    }
    ...
    /// Values used to create the list of selectable years. By default the year values range between the `min` and `max` datetime inputs. However, to control exactly which years to display, the `yearValues` input can take a number, an array of numbers, or string of comma separated numbers. For example, to show upcoming and recent leap years, then this input's value would be `yearValues="2008,2012,2016,2020,2024"`.
    /// </summary>
    public static void SetYearValues<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Collections.Generic.List<int>> yearValues) where T: IonDatetime
    {
        b.SetProperty(b.Const("yearValues"), yearValues);
    }
    ...
    /// Emits the ionCancel event and optionally closes the popover or modal that the datetime was presented in.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> cancel(this Metapsi.Syntax.ObjBuilder<IonDatetime> b, Metapsi.Syntax.Var<bool> closeOverlay = null)
    {
        return b.Call<Promise>("cancel", closeOverlay);
    }

    /// <summary>
    /// Confirms the selected datetime value, updates the `value` property, and optionally closes the popover or modal that the datetime was presented in.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> confirm(this Metapsi.Syntax.ObjBuilder<IonDatetime> b, Metapsi.Syntax.Var<bool> closeOverlay = null)
    {
        return b.Call<Promise>("confirm", closeOverlay);
    }

    /// <summary>
    /// Resets the internal state of the datetime but does not update the value. Passing a valid ISO-8601 string will reset the state of the component to the provided date. If no value is provided, the internal state will be reset to the clamped value of the min, max and today.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> reset(this Metapsi.Syntax.ObjBuilder<IonDatetime> b, Metapsi.Syntax.Var<string> startDate = null)
    {
        return b.Call<Promise>("reset", startDate);
    }
}