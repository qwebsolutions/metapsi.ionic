...
{
    /// <summary>
    /// Builds a "ion-fab-list" HTML tag
    /// </summary>
    ...
    {
        return b.IonicTag("ion-fab-list", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-fab-list" node
    /// </summary>
...
public static partial class IonFabListExtensions
{

    /// <summary>
    /// If `true`, the fab list will show all fab buttons in the list.
    /// </summary>
    public static void SetActivated<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonFabList
    {
        b.SetProperty(b.Const("activated"), b.Const(true));
    }
    public static void SetActivated<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> activated) where T: IonFabList
    {
        b.SetProperty(b.Const("activated"), activated);
    }
    ...
    /// The side the fab list will show on relative to the main fab button.
    /// </summary>
    public static void SetSideStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonFabList
    {
        b.SetProperty(b.Const("side"), b.Const("start"));
    }
    ...
    /// The side the fab list will show on relative to the main fab button.
    /// </summary>
    public static void SetSideEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonFabList
    {
        b.SetProperty(b.Const("side"), b.Const("end"));
    }
    ...
    /// The side the fab list will show on relative to the main fab button.
    /// </summary>
    public static void SetSideTop<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonFabList
    {
        b.SetProperty(b.Const("side"), b.Const("top"));
    }
    ...
    /// The side the fab list will show on relative to the main fab button.
    /// </summary>
    public static void SetSideBottom<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonFabList
    {
        b.SetProperty(b.Const("side"), b.Const("bottom"));
    }
}