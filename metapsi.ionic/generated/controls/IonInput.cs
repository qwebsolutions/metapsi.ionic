...
public class IonInput
{
    ...
    /// </summary>
    public string clearInputIcon { get; set; }
    ...
    /// </summary>
    public System.Func<int, int, string> counterFormatter { get; set; }
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonInput> instead")]
...
public static partial class IonInputControl
{
    ...
    {
        return b.IonicTag("ion-input", children);
    }
    ...
    {
        b.SetAttribute("clear-input-icon", clearInputIcon);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-input" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("on"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("off"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("honorific-prefix"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("given-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("additional-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("family-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("honorific-suffix"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("nickname"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("email"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("username"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("new-password"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("current-password"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("one-time-code"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("organization-title"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("organization"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("street-address"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line1"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line2"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line3"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level4"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level3"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level2"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level1"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("country"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("country-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("postal-code"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-given-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-additional-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-family-name"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-number"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp-month"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp-year"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-csc"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-type"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("transaction-currency"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("transaction-amount"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("language"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-day"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-month"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-year"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("sex"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-country-code"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-national"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-area-code"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-local"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-extension"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("impp"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("url"));
    }
    ...
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("photo"));
    }
    ...
    {
        b.SetProperty(b.Const("autocorrect"), b.Const("on"));
    }
    ...
    {
        b.SetProperty(b.Const("autocorrect"), b.Const("off"));
    }
    ...
    {
        b.SetProperty(b.Const("autofocus"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("autofocus"), autofocus);
    }
    ...
    {
        b.SetProperty(b.Const("clearInput"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("clearInput"), clearInput);
    }
    ...
    {
        b.SetProperty(b.Const("clearInputIcon"), clearInputIcon);
    }
    ...
    {
        b.SetProperty(b.Const("clearOnEdit"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("clearOnEdit"), clearOnEdit);
    }
    ...
    {
        b.SetProperty(b.Const("counterFormatter"), counterFormatter);
    }
    ...
    {
        b.SetProperty(b.Const("debounce"), debounce);
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("enter"));
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("done"));
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("go"));
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("next"));
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("previous"));
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("search"));
    }
    ...
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("send"));
    }
    ...
    {
        b.SetProperty(b.Const("label"), label);
    }
    ...
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("start"));
    }
    ...
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("end"));
    }
    ...
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("fixed"));
    }
    ...
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("stacked"));
    }
    ...
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("floating"));
    }
    ...
    {
        b.SetProperty(b.Const("maxlength"), maxlength);
    }
    ...
    {
        b.SetProperty(b.Const("minlength"), minlength);
    }
    ...
    {
        b.SetProperty(b.Const("placeholder"), placeholder);
    }
    ...
    {
        b.SetProperty(b.Const("spellcheck"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("spellcheck"), spellcheck);
    }
    ...
    {
        b.SetProperty(b.Const("step"), step);
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("date"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("time"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("month"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("email"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("tel"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("url"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("search"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("password"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("week"));
    }
    ...
    {
        b.SetProperty(b.Const("type"), b.Const("datetime-local"));
    }
    ...
    /// The value of the input.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<decimal> value) where T: IonInput
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// Emitted when the input loses focus.
    /// </summary>
    public static void OnIonBlur<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<FocusEvent>>> action) where T: IonInput
    {
        b.SetProperty(b.Const("onionBlur"), b.Const(action));
    }
    ...
    /// The `ionChange` event is fired when the user modifies the input's value. Unlike the `ionInput` event, the `ionChange` event is only fired when changes are committed, not as the user types.  Depending on the way the users interacts with the element, the `ionChange` event fires at a different moment: - When the user commits the change explicitly (e.g. by selecting a date from a date picker for `&lt;ion-input type="date"&gt;`, pressing the "Enter" key, etc.). - When the element loses focus after its value has changed: for elements where the user's interaction is typing.  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<InputChangeEventDetail>>> action) where T: IonInput
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
    ...
    /// Emitted when the input has focus.
    /// </summary>
    public static void OnIonFocus<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<FocusEvent>>> action) where T: IonInput
    {
        b.SetProperty(b.Const("onionFocus"), b.Const(action));
    }
    ...
    /// The `ionInput` event is fired each time the user modifies the input's value. Unlike the `ionChange` event, the `ionInput` event is fired for each alteration to the input's value. This typically happens for each keystroke as the user types.  For elements that accept text input (`type=text`, `type=tel`, etc.), the interface is [`InputEvent`](https://developer.mozilla.org/en-US/docs/Web/API/InputEvent); for others, the interface is [`Event`](https://developer.mozilla.org/en-US/docs/Web/API/Event). If the input is cleared on edit, the type is `null`.
    /// </summary>
    public static void OnIonInput<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<InputInputEventDetail>>> action) where T: IonInput
    {
        b.SetProperty(b.Const("onionInput"), b.Const(action));
    }
}
public static partial class IonInputExtensions
{

    /// <summary>
    /// Indicates whether and how the text value should be automatically capitalized as it is entered/edited by the user. Available options: `"off"`, `"none"`, `"on"`, `"sentences"`, `"words"`, `"characters"`.
    /// </summary>
    public static void SetAutocapitalize<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> autocapitalize) where T: IonInput
    {
        b.SetProperty(b.Const("autocapitalize"), autocapitalize);
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteOn<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("on"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteOff<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("off"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteHonorificPrefix<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("honorific-prefix"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteGivenName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("given-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAdditionalName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("additional-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteFamilyName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("family-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteHonorificSuffix<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("honorific-suffix"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteNickname<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("nickname"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("email"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteUsername<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("username"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteNewPassword<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("new-password"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCurrentPassword<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("current-password"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteOneTimeCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("one-time-code"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteOrganizationTitle<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("organization-title"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteOrganization<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("organization"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteStreetAddress<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("street-address"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLine1<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line1"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLine2<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line2"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLine3<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line3"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLevel4<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level4"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLevel3<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level3"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLevel2<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level2"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteAddressLevel1<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level1"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCountry<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("country"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCountryName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("country-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompletePostalCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("postal-code"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcGivenName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-given-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcAdditionalName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-additional-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcFamilyName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-family-name"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcNumber<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-number"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcExp<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcExpMonth<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp-month"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcExpYear<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp-year"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcCsc<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-csc"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteCcType<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-type"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTransactionCurrency<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("transaction-currency"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTransactionAmount<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("transaction-amount"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteLanguage<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("language"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteBday<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteBdayDay<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-day"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteBdayMonth<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-month"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteBdayYear<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-year"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteSex<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("sex"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTelCountryCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-country-code"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTelNational<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-national"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTelAreaCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-area-code"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTelLocal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-local"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteTelExtension<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-extension"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteImpp<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("impp"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompleteUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("url"));
    }
    ...
    /// Indicates whether the value of the control can be automatically completed by the browser.
    /// </summary>
    public static void SetAutocompletePhoto<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("photo"));
    }
    ...
    /// Whether auto correction should be enabled when the user is entering/editing the text value.
    /// </summary>
    public static void SetAutocorrectOn<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocorrect"), b.Const("on"));
    }
    ...
    /// Whether auto correction should be enabled when the user is entering/editing the text value.
    /// </summary>
    public static void SetAutocorrectOff<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autocorrect"), b.Const("off"));
    }
    ...
    /// Sets the [`autofocus` attribute](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/autofocus) on the native input element.  This may not be sufficient for the element to be focused on page load. See [managing focus](/docs/developing/managing-focus) for more information.
    /// </summary>
    public static void SetAutofocus<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("autofocus"), b.Const(true));
    }
    public static void SetAutofocus<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> autofocus) where T: IonInput
    {
        b.SetProperty(b.Const("autofocus"), autofocus);
    }
    ...
    /// If `true`, a clear icon will appear in the input when there is a value. Clicking it clears the input.
    /// </summary>
    public static void SetClearInput<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("clearInput"), b.Const(true));
    }
    public static void SetClearInput<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> clearInput) where T: IonInput
    {
        b.SetProperty(b.Const("clearInput"), clearInput);
    }
    ...
    /// The icon to use for the clear button. Only applies when `clearInput` is set to `true`.
    /// </summary>
    public static void SetClearInputIcon<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> clearInputIcon) where T: IonInput
    {
        b.SetProperty(b.Const("clearInputIcon"), clearInputIcon);
    }
    ...
    /// If `true`, the value will be cleared after focus upon edit. Defaults to `true` when `type` is `"password"`, `false` for all other types.
    /// </summary>
    public static void SetClearOnEdit<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("clearOnEdit"), b.Const(true));
    }
    public static void SetClearOnEdit<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> clearOnEdit) where T: IonInput
    {
        b.SetProperty(b.Const("clearOnEdit"), clearOnEdit);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonInput
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// If `true`, a character counter will display the ratio of characters used and the total character limit. Developers must also set the `maxlength` property for the counter to be calculated correctly.
    /// </summary>
    public static void SetCounter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("counter"), b.Const(true));
    }
    public static void SetCounter<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> counter) where T: IonInput
    {
        b.SetProperty(b.Const("counter"), counter);
    }
    ...
    /// A callback used to format the counter text. By default the counter text is set to "itemLength / maxLength".  See https://ionicframework.com/docs/troubleshooting/runtime#accessing-this if you need to access `this` from within the callback.
    /// </summary>
    public static void SetCounterFormatter<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<int, int, string>> counterFormatter) where T: IonInput
    {
        b.SetProperty(b.Const("counterFormatter"), counterFormatter);
    }
    ...
    /// Set the amount of time, in milliseconds, to wait to trigger the `ionInput` event after each keystroke.
    /// </summary>
    public static void SetDebounce<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> debounce) where T: IonInput
    {
        b.SetProperty(b.Const("debounce"), debounce);
    }
    ...
    /// If `true`, the user cannot interact with the input.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonInput
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintEnter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("enter"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintDone<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("done"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintGo<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("go"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintNext<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("next"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintPrevious<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("previous"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("search"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintSend<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("send"));
    }
    ...
    /// Text that is placed under the input and displayed when an error is detected.
    /// </summary>
    public static void SetErrorText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> errorText) where T: IonInput
    {
        b.SetProperty(b.Const("errorText"), errorText);
    }
    ...
    /// The fill for the item. If `"solid"` the item will have a background. If `"outline"` the item will be transparent with a border. Only available in `md` mode.
    /// </summary>
    public static void SetFillOutline<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("fill"), b.Const("outline"));
    }
    ...
    /// The fill for the item. If `"solid"` the item will have a background. If `"outline"` the item will be transparent with a border. Only available in `md` mode.
    /// </summary>
    public static void SetFillSolid<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("fill"), b.Const("solid"));
    }
    ...
    /// Text that is placed under the input and displayed when no error is detected.
    /// </summary>
    public static void SetHelperText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> helperText) where T: IonInput
    {
        b.SetProperty(b.Const("helperText"), helperText);
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("email"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("tel"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("url"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("search"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeNone<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("none"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeText<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("text"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeNumeric<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("numeric"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeDecimal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("inputmode"), b.Const("decimal"));
    }
    ...
    /// The visible label associated with the input.  Use this if you need to render a plaintext label.  The `label` property will take priority over the `label` slot if both are used.
    /// </summary>
    public static void SetLabel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> label) where T: IonInput
    {
        b.SetProperty(b.Const("label"), label);
    }
    ...
    /// Where to place the label relative to the input. `"start"`: The label will appear to the left of the input in LTR and to the right in RTL. `"end"`: The label will appear to the right of the input in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the input when the input is focused or it has a value. Otherwise it will appear on top of the input. `"stacked"`: The label will appear smaller and above the input regardless even when the input is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("start"));
    }
    ...
    /// Where to place the label relative to the input. `"start"`: The label will appear to the left of the input in LTR and to the right in RTL. `"end"`: The label will appear to the right of the input in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the input when the input is focused or it has a value. Otherwise it will appear on top of the input. `"stacked"`: The label will appear smaller and above the input regardless even when the input is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("end"));
    }
    ...
    /// Where to place the label relative to the input. `"start"`: The label will appear to the left of the input in LTR and to the right in RTL. `"end"`: The label will appear to the right of the input in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the input when the input is focused or it has a value. Otherwise it will appear on top of the input. `"stacked"`: The label will appear smaller and above the input regardless even when the input is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementFixed<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("fixed"));
    }
    ...
    /// Where to place the label relative to the input. `"start"`: The label will appear to the left of the input in LTR and to the right in RTL. `"end"`: The label will appear to the right of the input in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the input when the input is focused or it has a value. Otherwise it will appear on top of the input. `"stacked"`: The label will appear smaller and above the input regardless even when the input is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementStacked<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("stacked"));
    }
    ...
    /// Where to place the label relative to the input. `"start"`: The label will appear to the left of the input in LTR and to the right in RTL. `"end"`: The label will appear to the right of the input in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the input when the input is focused or it has a value. Otherwise it will appear on top of the input. `"stacked"`: The label will appear smaller and above the input regardless even when the input is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementFloating<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("floating"));
    }
    ...
    /// The maximum value, which must not be less than its minimum (min attribute) value.
    /// </summary>
    public static void SetMax<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> max) where T: IonInput
    {
        b.SetProperty(b.Const("max"), max);
    }
    ...
    /// The maximum value, which must not be less than its minimum (min attribute) value.
    /// </summary>
    public static void SetMax<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> max) where T: IonInput
    {
        b.SetProperty(b.Const("max"), max);
    }
    ...
    /// If the value of the type attribute is `text`, `email`, `search`, `password`, `tel`, or `url`, this attribute specifies the maximum number of characters that the user can enter.
    /// </summary>
    public static void SetMaxlength<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> maxlength) where T: IonInput
    {
        b.SetProperty(b.Const("maxlength"), maxlength);
    }
    ...
    /// The minimum value, which must not be greater than its maximum (max attribute) value.
    /// </summary>
    public static void SetMin<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> min) where T: IonInput
    {
        b.SetProperty(b.Const("min"), min);
    }
    ...
    /// The minimum value, which must not be greater than its maximum (max attribute) value.
    /// </summary>
    public static void SetMin<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> min) where T: IonInput
    {
        b.SetProperty(b.Const("min"), min);
    }
    ...
    /// If the value of the type attribute is `text`, `email`, `search`, `password`, `tel`, or `url`, this attribute specifies the minimum number of characters that the user can enter.
    /// </summary>
    public static void SetMinlength<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> minlength) where T: IonInput
    {
        b.SetProperty(b.Const("minlength"), minlength);
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// If `true`, the user can enter more than one value. This attribute applies when the type attribute is set to `"email"`, otherwise it is ignored.
    /// </summary>
    public static void SetMultiple<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("multiple"), b.Const(true));
    }
    public static void SetMultiple<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> multiple) where T: IonInput
    {
        b.SetProperty(b.Const("multiple"), multiple);
    }
    ...
    /// The name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonInput
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// A regular expression that the value is checked against. The pattern must match the entire value, not just some subset. Use the title attribute to describe the pattern to help the user. This attribute applies when the value of the type attribute is `"text"`, `"search"`, `"tel"`, `"url"`, `"email"`, `"date"`, or `"password"`, otherwise it is ignored. When the type attribute is `"date"`, `pattern` will only be used in browsers that do not support the `"date"` input type natively. See https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/date for more information.
    /// </summary>
    public static void SetPattern<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> pattern) where T: IonInput
    {
        b.SetProperty(b.Const("pattern"), pattern);
    }
    ...
    /// Instructional text that shows before the input has a value. This property applies only when the `type` property is set to `"email"`, `"number"`, `"password"`, `"search"`, `"tel"`, `"text"`, or `"url"`, otherwise it is ignored.
    /// </summary>
    public static void SetPlaceholder<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> placeholder) where T: IonInput
    {
        b.SetProperty(b.Const("placeholder"), placeholder);
    }
    ...
    /// If `true`, the user cannot modify the value.
    /// </summary>
    public static void SetReadonly<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("readonly"), b.Const(true));
    }
    public static void SetReadonly<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> @readonly) where T: IonInput
    {
        b.SetProperty(b.Const("readonly"), @readonly);
    }
    ...
    /// If `true`, the user must fill in a value before submitting a form.
    /// </summary>
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("required"), b.Const(true));
    }
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> required) where T: IonInput
    {
        b.SetProperty(b.Const("required"), required);
    }
    ...
    /// The shape of the input. If "round" it will have an increased border radius.
    /// </summary>
    public static void SetShapeRound<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("shape"), b.Const("round"));
    }
    ...
    /// If `true`, the element will have its spelling and grammar checked.
    /// </summary>
    public static void SetSpellcheck<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("spellcheck"), b.Const(true));
    }
    public static void SetSpellcheck<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> spellcheck) where T: IonInput
    {
        b.SetProperty(b.Const("spellcheck"), spellcheck);
    }
    ...
    /// Works with the min and max attributes to limit the increments at which a value can be set. Possible values are: `"any"` or a positive floating point number.
    /// </summary>
    public static void SetStep<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> step) where T: IonInput
    {
        b.SetProperty(b.Const("step"), step);
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeNumber<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("number"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeDate<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("date"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeTime<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("time"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeMonth<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("month"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("email"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("tel"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("url"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("search"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeText<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("text"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypePassword<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("password"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeWeek<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("week"));
    }
    ...
    /// The type of control to display. The default type is text.
    /// </summary>
    public static void SetTypeDatetimeLocal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonInput
    {
        b.SetProperty(b.Const("type"), b.Const("datetime-local"));
    }
    ...
    /// The value of the input.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> value) where T: IonInput
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// The value of the input.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> value) where T: IonInput
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// The value of the input.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<decimal> value) where T: IonInput
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// Returns the native `&lt;input&gt;` element used under the hood.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<HTMLInputElement>> getInputElement(this Metapsi.Syntax.ObjBuilder<IonInput> b)
    {
        return b.Call<Promise<HTMLInputElement>>("getInputElement");
    }

    /// <summary>
    /// Sets focus on the native `input` in `ion-input`. Use this method instead of the global `input.focus()`.  Developers who wish to focus an input when a page enters should call `setFocus()` in the `ionViewDidEnter()` lifecycle method.  Developers who wish to focus an input when an overlay is presented should call `setFocus` after `didPresent` has resolved.  See [managing focus](/docs/developing/managing-focus) for more information.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> setFocus(this Metapsi.Syntax.ObjBuilder<IonInput> b)
    {
        return b.Call<Promise>("setFocus");
    }
}