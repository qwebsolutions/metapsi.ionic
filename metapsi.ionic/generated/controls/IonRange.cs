...
public class IonRange
{
    ...
    /// </summary>
    public System.Func<object, object> pinFormatter { get; set; }
...
public static partial class IonRangeControl
{
    ...
    {
        return b.IonicTag("ion-range", children);
    }
    ...
    /// Maximum integer value of the range.
    /// </summary>
    public static void SetMax(this Metapsi.Html.AttributesBuilder<IonRange> b, string max)
    {
    ...
    /// Minimum integer value of the range.
    /// </summary>
    public static void SetMin(this Metapsi.Html.AttributesBuilder<IonRange> b, string min)
    {
    ...
    /// Specifies the value granularity.
    /// </summary>
    public static void SetStep(this Metapsi.Html.AttributesBuilder<IonRange> b, string step)
    {
    ...
    /// <summary>
    /// Builds a virtual "ion-range" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("activeBarStart"), activeBarStart);
    }
    ...
    {
        b.SetProperty(b.Const("dualKnobs"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("dualKnobs"), dualKnobs);
    }
    ...
    {
        b.SetProperty(b.Const("pin"), b.Const(true));
    }
    public static void SetPin<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<bool> pin) where T: IonRange
    {
        b.SetProperty(b.Const("pin"), pin);
    }

    /// <summary>
    /// A callback used to format the pin text. By default the pin text is set to `Math.round(value)`.  See https://ionicframework.com/docs/troubleshooting/runtime#accessing-this if you need to access `this` from within the callback.
    /// </summary>
    public static void SetPinFormatter<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<System.Func<object, object>> pinFormatter) where T: IonRange
    {
        b.SetProperty(b.Const("pinFormatter"), pinFormatter);
    }
    ...
    {
        b.SetProperty(b.Const("snaps"), b.Const(true));
    }
    public static void SetSnaps<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<bool> snaps) where T: IonRange
    {
        b.SetProperty(b.Const("snaps"), snaps);
    }

    /// <summary>
    /// Specifies the value granularity.
    /// </summary>
    public static void SetStep<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<int> step) where T: IonRange
    {
    ...
    {
        b.SetProperty(b.Const("ticks"), b.Const(true));
    }
    public static void SetTicks<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<bool> ticks) where T: IonRange
    {
        b.SetProperty(b.Const("ticks"), ticks);
    }

    /// <summary>
    /// the value of the range.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<int> value) where T: IonRange
    {
    ...
    /// the value of the range.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<RangeValues> value) where T: IonRange
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// The `ionChange` event is fired for `&lt;ion-range&gt;` elements when the user modifies the element's value: - When the user releases the knob after dragging; - When the user moves the knob with keyboard arrows  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<RangeChangeEventDetail>>> action) where T: IonRange
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
    ...
    /// The `ionInput` event is fired for `&lt;ion-range&gt;` elements when the value is modified. Unlike `ionChange`, `ionInput` is fired continuously while the user is dragging the knob.
    /// </summary>
    public static void OnIonInput<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<RangeChangeEventDetail>>> action) where T: IonRange
    {
        b.SetProperty(b.Const("onionInput"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionKnobMoveEnd"), b.Const(action));
    }
    ...
    /// Emitted when the user finishes moving the range knob, whether through mouse drag, touch gesture, or keyboard interaction.
    /// </summary>
    public static void OnIonKnobMoveEnd<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<RangeKnobMoveEndEventDetail>>> action) where T: IonRange
    {
        b.SetProperty(b.Const("onionKnobMoveEnd"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionKnobMoveStart"), b.Const(action));
    }
    ...
    /// Emitted when the user starts moving the range knob, whether through mouse drag, touch gesture, or keyboard interaction.
    /// </summary>
    public static void OnIonKnobMoveStart<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<RangeKnobMoveStartEventDetail>>> action) where T: IonRange
    {
        b.SetProperty(b.Const("onionKnobMoveStart"), b.Const(action));
    }
}
public static partial class IonRangeExtensions
{

    /// <summary>
    /// The start position of the range active bar. This feature is only available with a single knob (dualKnobs="false"). Valid values are greater than or equal to the min value and less than or equal to the max value.
    /// </summary>
    public static void SetActiveBarStart<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> activeBarStart) where T: IonRange
    {
        b.SetProperty(b.Const("activeBarStart"), activeBarStart);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonRange
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// How long, in milliseconds, to wait to trigger the `ionInput` event after each change in the range value.
    /// </summary>
    public static void SetDebounce<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> debounce) where T: IonRange
    {
        b.SetProperty(b.Const("debounce"), debounce);
    }
    ...
    /// If `true`, the user cannot interact with the range.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonRange
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// Show two knobs.
    /// </summary>
    public static void SetDualKnobs<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("dualKnobs"), b.Const(true));
    }
    public static void SetDualKnobs<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> dualKnobs) where T: IonRange
    {
        b.SetProperty(b.Const("dualKnobs"), dualKnobs);
    }
    ...
    /// The text to display as the control's label. Use this over the `label` slot if you only need plain text. The `label` property will take priority over the `label` slot if both are used.
    /// </summary>
    public static void SetLabel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> label) where T: IonRange
    {
        b.SetProperty(b.Const("label"), label);
    }
    ...
    /// Where to place the label relative to the range. `"start"`: The label will appear to the left of the range in LTR and to the right in RTL. `"end"`: The label will appear to the right of the range in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the range regardless of the direction.
    /// </summary>
    public static void SetLabelPlacementStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("start"));
    }
    ...
    /// Where to place the label relative to the range. `"start"`: The label will appear to the left of the range in LTR and to the right in RTL. `"end"`: The label will appear to the right of the range in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the range regardless of the direction.
    /// </summary>
    public static void SetLabelPlacementEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("end"));
    }
    ...
    /// Where to place the label relative to the range. `"start"`: The label will appear to the left of the range in LTR and to the right in RTL. `"end"`: The label will appear to the right of the range in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the range regardless of the direction.
    /// </summary>
    public static void SetLabelPlacementFixed<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("fixed"));
    }
    ...
    /// Where to place the label relative to the range. `"start"`: The label will appear to the left of the range in LTR and to the right in RTL. `"end"`: The label will appear to the right of the range in LTR and to the left in RTL. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). `"stacked"`: The label will appear above the range regardless of the direction.
    /// </summary>
    public static void SetLabelPlacementStacked<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("stacked"));
    }
    ...
    /// Maximum integer value of the range.
    /// </summary>
    public static void SetMax<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> max) where T: IonRange
    {
        b.SetProperty(b.Const("max"), max);
    }
    ...
    /// Minimum integer value of the range.
    /// </summary>
    public static void SetMin<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> min) where T: IonRange
    {
        b.SetProperty(b.Const("min"), min);
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// The name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonRange
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// If `true`, a pin with integer value is shown when the knob is pressed.
    /// </summary>
    public static void SetPin<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("pin"), b.Const(true));
    }
    public static void SetPin<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> pin) where T: IonRange
    {
        b.SetProperty(b.Const("pin"), pin);
    }
    ...
    /// A callback used to format the pin text. By default the pin text is set to `Math.round(value)`.  See https://ionicframework.com/docs/troubleshooting/runtime#accessing-this if you need to access `this` from within the callback.
    /// </summary>
    public static void SetPinFormatter<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<object, object>> pinFormatter) where T: IonRange
    {
        b.SetProperty(b.Const("pinFormatter"), pinFormatter);
    }
    ...
    /// If `true`, the knob snaps to tick marks evenly spaced based on the step property value.
    /// </summary>
    public static void SetSnaps<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("snaps"), b.Const(true));
    }
    public static void SetSnaps<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> snaps) where T: IonRange
    {
        b.SetProperty(b.Const("snaps"), snaps);
    }
    ...
    /// Specifies the value granularity.
    /// </summary>
    public static void SetStep<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> step) where T: IonRange
    {
        b.SetProperty(b.Const("step"), step);
    }
    ...
    /// Specifies the value granularity.
    /// </summary>
    public static void SetStep<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<decimal> step) where T: IonRange
    {
        b.SetProperty(b.Const("step"), step);
    }
    ...
    /// If `true`, tick marks are displayed based on the step value. Only applies when `snaps` is `true`.
    /// </summary>
    public static void SetTicks<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRange
    {
        b.SetProperty(b.Const("ticks"), b.Const(true));
    }
    public static void SetTicks<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> ticks) where T: IonRange
    {
        b.SetProperty(b.Const("ticks"), ticks);
    }
    ...
    /// the value of the range.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> value) where T: IonRange
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// the value of the range.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<decimal> value) where T: IonRange
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// the value of the range.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<RangeValues> value) where T: IonRange
    {
        b.SetProperty(b.Const("value"), value);
    }
}