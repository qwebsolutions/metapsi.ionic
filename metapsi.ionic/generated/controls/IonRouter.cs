...
public class IonRouter
{
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonRouter> instead")]
...
public static partial class IonRouterControl
{
    ...
    {
        return b.IonicTag("ion-router", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-router" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("onionRouteDidChange"), b.Const(action));
    }
    ...
    /// Emitted when the route had changed
    /// </summary>
    public static void OnIonRouteDidChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<RouterEventDetail>>> action) where T: IonRouter
    {
        b.SetProperty(b.Const("onionRouteDidChange"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionRouteWillChange"), b.Const(action));
    }
    ...
    /// Event emitted when the route is about to change
    /// </summary>
    public static void OnIonRouteWillChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<RouterEventDetail>>> action) where T: IonRouter
    {
        b.SetProperty(b.Const("onionRouteWillChange"), b.Const(action));
    }
}
public static partial class IonRouterExtensions
{

    /// <summary>
    /// The root path to use when matching URLs. By default, this is set to "/", but you can specify an alternate prefix for all URL paths.
    /// </summary>
    public static void SetRoot<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> root) where T: IonRouter
    {
        b.SetProperty(b.Const("root"), root);
    }
    ...
    /// The router can work in two "modes": - With hash: `/index.html#/path/to/page` - Without hash: `/path/to/page`  Using one or another might depend in the requirements of your app and/or where it's deployed.  Usually "hash-less" navigation works better for SEO and it's more user friendly too, but it might requires additional server-side configuration in order to properly work.  On the other side hash-navigation is much easier to deploy, it even works over the file protocol.  By default, this property is `true`, change to `false` to allow hash-less URLs.
    /// </summary>
    public static void SetUseHash<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonRouter
    {
        b.SetProperty(b.Const("useHash"), b.Const(true));
    }
    public static void SetUseHash<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> useHash) where T: IonRouter
    {
        b.SetProperty(b.Const("useHash"), useHash);
    }
    ...
    /// Go back to previous page in the window.history.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> back(this Metapsi.Syntax.ObjBuilder<IonRouter> b)
    {
        return b.Call<Promise>("back");
    }

    /// <summary>
    /// Navigate to the specified path.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<bool>> pushForward(this Metapsi.Syntax.ObjBuilder<IonRouter> b, Metapsi.Syntax.Var<string> path, Metapsi.Syntax.Var<System.Func<object, object, Animation>> animation = null)
    {
        return b.Call<Promise<bool>>("push", path, b.Const("forward"), animation);
    }

    /// <summary>
    /// Navigate to the specified path.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<bool>> pushBack(this Metapsi.Syntax.ObjBuilder<IonRouter> b, Metapsi.Syntax.Var<string> path, Metapsi.Syntax.Var<System.Func<object, object, Animation>> animation = null)
    {
        return b.Call<Promise<bool>>("push", path, b.Const("back"), animation);
    }

    /// <summary>
    /// Navigate to the specified path.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<bool>> pushRoot(this Metapsi.Syntax.ObjBuilder<IonRouter> b, Metapsi.Syntax.Var<string> path, Metapsi.Syntax.Var<System.Func<object, object, Animation>> animation = null)
    {
        return b.Call<Promise<bool>>("push", path, b.Const("root"), animation);
    }

    /// <summary>
    /// Navigate to the specified path.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<bool>> push(this Metapsi.Syntax.ObjBuilder<IonRouter> b, Metapsi.Syntax.Var<string> path)
    {
        return b.Call<Promise<bool>>("push", path);
    }
}