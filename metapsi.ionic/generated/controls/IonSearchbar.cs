...
public class IonSearchbar
{
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonSearchbar> instead")]
...
{
    /// <summary>
    /// Builds a "ion-searchbar" HTML tag
    /// </summary>
    ...
    {
        return b.IonicTag("ion-searchbar", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-searchbar" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("cancelButtonIcon"), cancelButtonIcon);
    }
    ...
    {
        b.SetProperty(b.Const("cancelButtonText"), cancelButtonText);
    }
    ...
    {
        b.SetProperty(b.Const("clearIcon"), clearIcon);
    }
    ...
    {
        b.SetProperty(b.Const("searchIcon"), searchIcon);
    }
    ...
    {
        b.SetProperty(b.Const("showCancelButton"), b.Const("never"));
    }
    ...
    {
        b.SetProperty(b.Const("showCancelButton"), b.Const("focus"));
    }
    ...
    {
        b.SetProperty(b.Const("showCancelButton"), b.Const("always"));
    }
    ...
    {
        b.SetProperty(b.Const("showClearButton"), b.Const("never"));
    }
    ...
    {
        b.SetProperty(b.Const("showClearButton"), b.Const("focus"));
    }
    ...
    {
        b.SetProperty(b.Const("showClearButton"), b.Const("always"));
    }
    ...
    {
        b.SetProperty(b.Const("onionCancel"), b.Const(action));
    }
    ...
    /// The `ionChange` event is fired for `&lt;ion-searchbar&gt;` elements when the user modifies the element's value. Unlike the `ionInput` event, the `ionChange` event is not necessarily fired for each alteration to an element's value.  The `ionChange` event is fired when the value has been committed by the user. This can happen when the element loses focus or when the "Enter" key is pressed. `ionChange` can also fire when clicking the clear or cancel buttons.  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<SearchbarChangeEventDetail>>> action) where T: IonSearchbar
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionClear"), b.Const(action));
    }
    ...
    /// Emitted when the `value` of the `ion-searchbar` element has changed.
    /// </summary>
    public static void OnIonInput<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<SearchbarInputEventDetail>>> action) where T: IonSearchbar
    {
        b.SetProperty(b.Const("onionInput"), b.Const(action));
    }
}
public static partial class IonSearchbarExtensions
{

    /// <summary>
    /// If `true`, enable searchbar animation.
    /// </summary>
    public static void SetAnimated<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("animated"), b.Const(true));
    }
    public static void SetAnimated<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> animated) where T: IonSearchbar
    {
        b.SetProperty(b.Const("animated"), animated);
    }
    ...
    /// Indicates whether and how the text value should be automatically capitalized as it is entered/edited by the user. Available options: `"off"`, `"none"`, `"on"`, `"sentences"`, `"words"`, `"characters"`.
    /// </summary>
    public static void SetAutocapitalize<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> autocapitalize) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocapitalize"), autocapitalize);
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteOn<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("on"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteOff<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("off"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteHonorificPrefix<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("honorific-prefix"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteGivenName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("given-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAdditionalName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("additional-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteFamilyName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("family-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteHonorificSuffix<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("honorific-suffix"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteNickname<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("nickname"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("email"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteUsername<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("username"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteNewPassword<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("new-password"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCurrentPassword<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("current-password"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteOneTimeCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("one-time-code"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteOrganizationTitle<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("organization-title"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteOrganization<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("organization"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteStreetAddress<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("street-address"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLine1<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line1"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLine2<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line2"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLine3<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-line3"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLevel4<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level4"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLevel3<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level3"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLevel2<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level2"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteAddressLevel1<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("address-level1"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCountry<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("country"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCountryName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("country-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompletePostalCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("postal-code"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcGivenName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-given-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcAdditionalName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-additional-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcFamilyName<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-family-name"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcNumber<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-number"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcExp<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcExpMonth<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp-month"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcExpYear<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-exp-year"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcCsc<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-csc"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteCcType<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("cc-type"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTransactionCurrency<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("transaction-currency"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTransactionAmount<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("transaction-amount"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteLanguage<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("language"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteBday<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteBdayDay<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-day"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteBdayMonth<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-month"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteBdayYear<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("bday-year"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteSex<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("sex"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTelCountryCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-country-code"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTelNational<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-national"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTelAreaCode<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-area-code"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTelLocal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-local"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteTelExtension<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("tel-extension"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteImpp<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("impp"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompleteUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("url"));
    }
    ...
    /// Set the input's autocomplete property.
    /// </summary>
    public static void SetAutocompletePhoto<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocomplete"), b.Const("photo"));
    }
    ...
    /// Set the input's autocorrect property.
    /// </summary>
    public static void SetAutocorrectOn<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocorrect"), b.Const("on"));
    }
    ...
    /// Set the input's autocorrect property.
    /// </summary>
    public static void SetAutocorrectOff<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("autocorrect"), b.Const("off"));
    }
    ...
    /// Set the cancel button icon. Only applies to `md` mode. Defaults to `arrow-back-sharp`.
    /// </summary>
    public static void SetCancelButtonIcon<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> cancelButtonIcon) where T: IonSearchbar
    {
        b.SetProperty(b.Const("cancelButtonIcon"), cancelButtonIcon);
    }
    ...
    /// Set the cancel button text. Only applies to `ios` mode.
    /// </summary>
    public static void SetCancelButtonText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> cancelButtonText) where T: IonSearchbar
    {
        b.SetProperty(b.Const("cancelButtonText"), cancelButtonText);
    }
    ...
    /// Set the clear icon. Defaults to `close-circle` for `ios` and `close-sharp` for `md`.
    /// </summary>
    public static void SetClearIcon<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> clearIcon) where T: IonSearchbar
    {
        b.SetProperty(b.Const("clearIcon"), clearIcon);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonSearchbar
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// Set the amount of time, in milliseconds, to wait to trigger the `ionInput` event after each keystroke.
    /// </summary>
    public static void SetDebounce<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> debounce) where T: IonSearchbar
    {
        b.SetProperty(b.Const("debounce"), debounce);
    }
    ...
    /// If `true`, the user cannot interact with the input.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonSearchbar
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintEnter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("enter"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintDone<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("done"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintGo<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("go"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintNext<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("next"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintPrevious<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("previous"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("search"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintSend<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("send"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("email"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("tel"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("url"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("search"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeNone<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("none"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeText<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("text"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeNumeric<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("numeric"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeDecimal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("inputmode"), b.Const("decimal"));
    }
    ...
    /// This attribute specifies the maximum number of characters that the user can enter.
    /// </summary>
    public static void SetMaxlength<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> maxlength) where T: IonSearchbar
    {
        b.SetProperty(b.Const("maxlength"), maxlength);
    }
    ...
    /// This attribute specifies the minimum number of characters that the user can enter.
    /// </summary>
    public static void SetMinlength<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> minlength) where T: IonSearchbar
    {
        b.SetProperty(b.Const("minlength"), minlength);
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// If used in a form, set the name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonSearchbar
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// Set the input's placeholder. `placeholder` can accept either plaintext or HTML as a string. To display characters normally reserved for HTML, they must be escaped. For example `&lt;Ionic&gt;` would become `&lt;Ionic&gt;`  For more information: [Security Documentation](https://ionicframework.com/docs/faq/security)
    /// </summary>
    public static void SetPlaceholder<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> placeholder) where T: IonSearchbar
    {
        b.SetProperty(b.Const("placeholder"), placeholder);
    }
    ...
    /// The icon to use as the search icon. Defaults to `search-outline` in `ios` mode and `search-sharp` in `md` mode.
    /// </summary>
    public static void SetSearchIcon<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> searchIcon) where T: IonSearchbar
    {
        b.SetProperty(b.Const("searchIcon"), searchIcon);
    }
    ...
    /// Sets the behavior for the cancel button. Defaults to `"never"`. Setting to `"focus"` shows the cancel button on focus. Setting to `"never"` hides the cancel button. Setting to `"always"` shows the cancel button regardless of focus state.
    /// </summary>
    public static void SetShowCancelButtonNever<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("showCancelButton"), b.Const("never"));
    }
    ...
    /// Sets the behavior for the cancel button. Defaults to `"never"`. Setting to `"focus"` shows the cancel button on focus. Setting to `"never"` hides the cancel button. Setting to `"always"` shows the cancel button regardless of focus state.
    /// </summary>
    public static void SetShowCancelButtonFocus<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("showCancelButton"), b.Const("focus"));
    }
    ...
    /// Sets the behavior for the cancel button. Defaults to `"never"`. Setting to `"focus"` shows the cancel button on focus. Setting to `"never"` hides the cancel button. Setting to `"always"` shows the cancel button regardless of focus state.
    /// </summary>
    public static void SetShowCancelButtonAlways<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("showCancelButton"), b.Const("always"));
    }
    ...
    /// Sets the behavior for the clear button. Defaults to `"focus"`. Setting to `"focus"` shows the clear button on focus if the input is not empty. Setting to `"never"` hides the clear button. Setting to `"always"` shows the clear button regardless of focus state, but only if the input is not empty.
    /// </summary>
    public static void SetShowClearButtonNever<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("showClearButton"), b.Const("never"));
    }
    ...
    /// Sets the behavior for the clear button. Defaults to `"focus"`. Setting to `"focus"` shows the clear button on focus if the input is not empty. Setting to `"never"` hides the clear button. Setting to `"always"` shows the clear button regardless of focus state, but only if the input is not empty.
    /// </summary>
    public static void SetShowClearButtonFocus<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("showClearButton"), b.Const("focus"));
    }
    ...
    /// Sets the behavior for the clear button. Defaults to `"focus"`. Setting to `"focus"` shows the clear button on focus if the input is not empty. Setting to `"never"` hides the clear button. Setting to `"always"` shows the clear button regardless of focus state, but only if the input is not empty.
    /// </summary>
    public static void SetShowClearButtonAlways<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("showClearButton"), b.Const("always"));
    }
    ...
    /// If `true`, enable spellcheck on the input.
    /// </summary>
    public static void SetSpellcheck<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("spellcheck"), b.Const(true));
    }
    public static void SetSpellcheck<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> spellcheck) where T: IonSearchbar
    {
        b.SetProperty(b.Const("spellcheck"), spellcheck);
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypeNumber<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("number"));
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypeEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("email"));
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypeTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("tel"));
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypeUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("url"));
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypeSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("search"));
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypeText<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("text"));
    }
    ...
    /// Set the type of the input.
    /// </summary>
    public static void SetTypePassword<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSearchbar
    {
        b.SetProperty(b.Const("type"), b.Const("password"));
    }
    ...
    /// the value of the searchbar.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> value) where T: IonSearchbar
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// Returns the native `&lt;input&gt;` element used under the hood.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<HTMLInputElement>> getInputElement(this Metapsi.Syntax.ObjBuilder<IonSearchbar> b)
    {
    ...
    /// Sets focus on the native `input` in `ion-searchbar`. Use this method instead of the global `input.focus()`. Developers who wish to focus an input when a page enters should call `setFocus()` in the `ionViewDidEnter()` lifecycle method. Developers who wish to focus an input when an overlay is presented should call `setFocus` after `didPresent` has resolved.  See [managing focus](/docs/developing/managing-focus) for more information.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> setFocus(this Metapsi.Syntax.ObjBuilder<IonSearchbar> b)
    {
