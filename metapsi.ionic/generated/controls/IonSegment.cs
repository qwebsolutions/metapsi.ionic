...
public static partial class IonSegmentControl
{
    ...
    {
        return b.IonicTag("ion-segment", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-segment" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("scrollable"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("scrollable"), scrollable);
    }
    ...
    {
        b.SetProperty(b.Const("selectOnFocus"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("selectOnFocus"), selectOnFocus);
    }
    ...
    /// Emitted when the value property has changed and any dragging pointer has been released from `ion-segment`.  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<SegmentChangeEventDetail>>> action) where T: IonSegment
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
}
public static partial class IonSegmentExtensions
{

    /// <summary>
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonSegment
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// If `true`, the user cannot interact with the segment.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonSegment
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// If `true`, the segment buttons will overflow and the user can swipe to see them. In addition, this will disable the gesture to drag the indicator between the buttons in order to swipe to see hidden buttons.
    /// </summary>
    public static void SetScrollable<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("scrollable"), b.Const(true));
    }
    public static void SetScrollable<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> scrollable) where T: IonSegment
    {
        b.SetProperty(b.Const("scrollable"), scrollable);
    }
    ...
    /// If `true`, navigating to an `ion-segment-button` with the keyboard will focus and select the element. If `false`, keyboard navigation will only focus the `ion-segment-button` element.
    /// </summary>
    public static void SetSelectOnFocus<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("selectOnFocus"), b.Const(true));
    }
    public static void SetSelectOnFocus<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> selectOnFocus) where T: IonSegment
    {
        b.SetProperty(b.Const("selectOnFocus"), selectOnFocus);
    }
    ...
    /// If `true`, users will be able to swipe between segment buttons to activate them.
    /// </summary>
    public static void SetSwipeGesture<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSegment
    {
        b.SetProperty(b.Const("swipeGesture"), b.Const(true));
    }
    public static void SetSwipeGesture<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> swipeGesture) where T: IonSegment
    {
        b.SetProperty(b.Const("swipeGesture"), swipeGesture);
    }
    ...
    /// the value of the segment.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> value) where T: IonSegment
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// the value of the segment.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> value) where T: IonSegment
    {
        b.SetProperty(b.Const("value"), value);
    }
}