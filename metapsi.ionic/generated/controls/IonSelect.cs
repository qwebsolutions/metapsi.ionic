...
public class IonSelect
{
    ...
    /// </summary>
    public object interfaceOptions { get; set; }
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonSelect> instead")]
...
public static partial class IonSelectControl
{
    ...
    {
        return b.IonicTag("ion-select", children);
    }
    ...
    /// Any additional options that the `alert`, `action-sheet` or `popover` interface can take. See the [ion-alert docs](./alert), the [ion-action-sheet docs](./action-sheet), the [ion-popover docs](./popover), and the [ion-modal docs](./modal) for the create options for each interface.  Note: `interfaceOptions` will not override `inputs` or `buttons` with the `alert` interface.
    /// </summary>
    public static void SetInterfaceOptions(this Metapsi.Html.AttributesBuilder<IonSelect> b, string interfaceOptions)
    {
    ...
    /// The value of the select.
    /// </summary>
    public static void SetValue(this Metapsi.Html.AttributesBuilder<IonSelect> b, string value)
    {
        b.SetAttribute("value", value);
    }
    /// <summary>
    /// Builds a virtual "ion-select" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("expandedIcon"), expandedIcon);
    }
    ...
    {
        b.SetProperty(b.Const("interface"), b.Const("action-sheet"));
    }
    ...
    {
        b.SetProperty(b.Const("interface"), b.Const("popover"));
    }
    ...
    {
        b.SetProperty(b.Const("interface"), b.Const("alert"));
    }
    ...
    {
        b.SetProperty(b.Const("interface"), b.Const("modal"));
    }
    ...
    {
        b.SetProperty(b.Const("interfaceOptions"), interfaceOptions);
    }
    ...
    {
        b.SetProperty(b.Const("okText"), okText);
    }
    ...
    {
        b.SetProperty(b.Const("selectedText"), selectedText);
    }
    ...
    /// Emitted when the value has changed.  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<SelectChangeEventDetail>>> action) where T: IonSelect
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
    ...
    {
        b.SetProperty(b.Const("onionDismiss"), b.Const(action));
    }
...
public static partial class IonSelectExtensions
{

    /// <summary>
    /// The text to display on the cancel button.
    /// </summary>
    public static void SetCancelText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> cancelText) where T: IonSelect
    {
        b.SetProperty(b.Const("cancelText"), cancelText);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).  This property is only available when using the modern select syntax.
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonSelect
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// This property allows developers to specify a custom function or property name for comparing objects when determining the selected option in the ion-select. When not specified, the default behavior will use strict equality (===) for comparison.
    /// </summary>
    public static void SetCompareWith<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> compareWith) where T: IonSelect
    {
        b.SetProperty(b.Const("compareWith"), compareWith);
    }
    ...
    /// This property allows developers to specify a custom function or property name for comparing objects when determining the selected option in the ion-select. When not specified, the default behavior will use strict equality (===) for comparison.
    /// </summary>
    public static void SetCompareWith<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<object, object, bool>> compareWith) where T: IonSelect
    {
        b.SetProperty(b.Const("compareWith"), compareWith);
    }
    ...
    /// If `true`, the user cannot interact with the select.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonSelect
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// Text that is placed under the select and displayed when an error is detected.
    /// </summary>
    public static void SetErrorText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> errorText) where T: IonSelect
    {
        b.SetProperty(b.Const("errorText"), errorText);
    }
    ...
    /// The toggle icon to show when the select is open. If defined, the icon rotation behavior in `md` mode will be disabled. If undefined, `toggleIcon` will be used for when the select is both open and closed.
    /// </summary>
    public static void SetExpandedIcon<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> expandedIcon) where T: IonSelect
    {
        b.SetProperty(b.Const("expandedIcon"), expandedIcon);
    }
    ...
    /// The fill for the item. If `"solid"` the item will have a background. If `"outline"` the item will be transparent with a border. Only available in `md` mode.
    /// </summary>
    public static void SetFillOutline<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("fill"), b.Const("outline"));
    }
    ...
    /// The fill for the item. If `"solid"` the item will have a background. If `"outline"` the item will be transparent with a border. Only available in `md` mode.
    /// </summary>
    public static void SetFillSolid<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("fill"), b.Const("solid"));
    }
    ...
    /// Text that is placed under the select and displayed when no error is detected.
    /// </summary>
    public static void SetHelperText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> helperText) where T: IonSelect
    {
        b.SetProperty(b.Const("helperText"), helperText);
    }
    ...
    /// The interface the select should use: `action-sheet`, `popover`, `alert`, or `modal`.
    /// </summary>
    public static void SetInterfaceActionSheet<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("interface"), b.Const("action-sheet"));
    }
    ...
    /// The interface the select should use: `action-sheet`, `popover`, `alert`, or `modal`.
    /// </summary>
    public static void SetInterfacePopover<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("interface"), b.Const("popover"));
    }
    ...
    /// The interface the select should use: `action-sheet`, `popover`, `alert`, or `modal`.
    /// </summary>
    public static void SetInterfaceAlert<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("interface"), b.Const("alert"));
    }
    ...
    /// The interface the select should use: `action-sheet`, `popover`, `alert`, or `modal`.
    /// </summary>
    public static void SetInterfaceModal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("interface"), b.Const("modal"));
    }
    ...
    /// Any additional options that the `alert`, `action-sheet` or `popover` interface can take. See the [ion-alert docs](./alert), the [ion-action-sheet docs](./action-sheet), the [ion-popover docs](./popover), and the [ion-modal docs](./modal) for the create options for each interface.  Note: `interfaceOptions` will not override `inputs` or `buttons` with the `alert` interface.
    /// </summary>
    public static void SetInterfaceOptions<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<object> interfaceOptions) where T: IonSelect
    {
        b.SetProperty(b.Const("interfaceOptions"), interfaceOptions);
    }
    ...
    /// How to pack the label and select within a line. `justify` does not apply when the label and select are on different lines when `labelPlacement` is set to `"floating"` or `"stacked"`. `"start"`: The label and select will appear on the left in LTR and on the right in RTL. `"end"`: The label and select will appear on the right in LTR and on the left in RTL. `"space-between"`: The label and select will appear on opposite ends of the line with space between the two elements.
    /// </summary>
    public static void SetJustifyStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("justify"), b.Const("start"));
    }
    ...
    /// How to pack the label and select within a line. `justify` does not apply when the label and select are on different lines when `labelPlacement` is set to `"floating"` or `"stacked"`. `"start"`: The label and select will appear on the left in LTR and on the right in RTL. `"end"`: The label and select will appear on the right in LTR and on the left in RTL. `"space-between"`: The label and select will appear on opposite ends of the line with space between the two elements.
    /// </summary>
    public static void SetJustifyEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("justify"), b.Const("end"));
    }
    ...
    /// How to pack the label and select within a line. `justify` does not apply when the label and select are on different lines when `labelPlacement` is set to `"floating"` or `"stacked"`. `"start"`: The label and select will appear on the left in LTR and on the right in RTL. `"end"`: The label and select will appear on the right in LTR and on the left in RTL. `"space-between"`: The label and select will appear on opposite ends of the line with space between the two elements.
    /// </summary>
    public static void SetJustifySpaceBetween<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("justify"), b.Const("space-between"));
    }
    ...
    /// The visible label associated with the select.  Use this if you need to render a plaintext label.  The `label` property will take priority over the `label` slot if both are used.
    /// </summary>
    public static void SetLabel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> label) where T: IonSelect
    {
        b.SetProperty(b.Const("label"), label);
    }
    ...
    /// Where to place the label relative to the select. `"start"`: The label will appear to the left of the select in LTR and to the right in RTL. `"end"`: The label will appear to the right of the select in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the select when the select is focused or it has a value. Otherwise it will appear on top of the select. `"stacked"`: The label will appear smaller and above the select regardless even when the select is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). When using `"floating"` or `"stacked"` we recommend initializing the select with either a `value` or a `placeholder`.
    /// </summary>
    public static void SetLabelPlacementStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("start"));
    }
    ...
    /// Where to place the label relative to the select. `"start"`: The label will appear to the left of the select in LTR and to the right in RTL. `"end"`: The label will appear to the right of the select in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the select when the select is focused or it has a value. Otherwise it will appear on top of the select. `"stacked"`: The label will appear smaller and above the select regardless even when the select is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). When using `"floating"` or `"stacked"` we recommend initializing the select with either a `value` or a `placeholder`.
    /// </summary>
    public static void SetLabelPlacementEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("end"));
    }
    ...
    /// Where to place the label relative to the select. `"start"`: The label will appear to the left of the select in LTR and to the right in RTL. `"end"`: The label will appear to the right of the select in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the select when the select is focused or it has a value. Otherwise it will appear on top of the select. `"stacked"`: The label will appear smaller and above the select regardless even when the select is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). When using `"floating"` or `"stacked"` we recommend initializing the select with either a `value` or a `placeholder`.
    /// </summary>
    public static void SetLabelPlacementFixed<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("fixed"));
    }
    ...
    /// Where to place the label relative to the select. `"start"`: The label will appear to the left of the select in LTR and to the right in RTL. `"end"`: The label will appear to the right of the select in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the select when the select is focused or it has a value. Otherwise it will appear on top of the select. `"stacked"`: The label will appear smaller and above the select regardless even when the select is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). When using `"floating"` or `"stacked"` we recommend initializing the select with either a `value` or a `placeholder`.
    /// </summary>
    public static void SetLabelPlacementStacked<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("stacked"));
    }
    ...
    /// Where to place the label relative to the select. `"start"`: The label will appear to the left of the select in LTR and to the right in RTL. `"end"`: The label will appear to the right of the select in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the select when the select is focused or it has a value. Otherwise it will appear on top of the select. `"stacked"`: The label will appear smaller and above the select regardless even when the select is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("..."). When using `"floating"` or `"stacked"` we recommend initializing the select with either a `value` or a `placeholder`.
    /// </summary>
    public static void SetLabelPlacementFloating<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("floating"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// If `true`, the select can accept multiple values.
    /// </summary>
    public static void SetMultiple<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("multiple"), b.Const(true));
    }
    public static void SetMultiple<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> multiple) where T: IonSelect
    {
        b.SetProperty(b.Const("multiple"), multiple);
    }
    ...
    /// The name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonSelect
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// The text to display on the ok button.
    /// </summary>
    public static void SetOkText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> okText) where T: IonSelect
    {
        b.SetProperty(b.Const("okText"), okText);
    }
    ...
    /// The text to display when the select is empty.
    /// </summary>
    public static void SetPlaceholder<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> placeholder) where T: IonSelect
    {
        b.SetProperty(b.Const("placeholder"), placeholder);
    }
    ...
    /// If true, screen readers will announce it as a required field. This property works only for accessibility purposes, it will not prevent the form from submitting if the value is invalid.
    /// </summary>
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("required"), b.Const(true));
    }
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> required) where T: IonSelect
    {
        b.SetProperty(b.Const("required"), required);
    }
    ...
    /// The text to display instead of the selected option's value.
    /// </summary>
    public static void SetSelectedText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> selectedText) where T: IonSelect
    {
        b.SetProperty(b.Const("selectedText"), selectedText);
    }
    ...
    /// The shape of the select. If "round" it will have an increased border radius.
    /// </summary>
    public static void SetShapeRound<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonSelect
    {
        b.SetProperty(b.Const("shape"), b.Const("round"));
    }
    ...
    /// The toggle icon to use. Defaults to `chevronExpand` for `ios` mode, or `caretDownSharp` for `md` mode.
    /// </summary>
    public static void SetToggleIcon<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> toggleIcon) where T: IonSelect
    {
        b.SetProperty(b.Const("toggleIcon"), toggleIcon);
    }
    ...
    /// The value of the select.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<object> value) where T: IonSelect
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// Open the select overlay. The overlay is either an alert, action sheet, or popover, depending on the `interface` property on the `ion-select`.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<object>> open(this Metapsi.Syntax.ObjBuilder<IonSelect> b, Metapsi.Syntax.Var<UIEvent> @event = null)
    {
        return b.Call<Promise<object>>("open", @event);
    }
}