...
{
    /// <summary>
    /// Builds a "ion-tab-button" HTML tag
    /// </summary>
    ...
    {
        return b.IonicTag("ion-tab-button", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-tab-button" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("selected"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("selected"), selected);
    }
...
public static partial class IonTabButtonExtensions
{

    /// <summary>
    /// If `true`, the user cannot interact with the tab button.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonTabButton
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// This attribute instructs browsers to download a URL instead of navigating to it, so the user will be prompted to save it as a local file. If the attribute has a value, it is used as the pre-filled file name in the Save prompt (the user can still change the file name if they want).
    /// </summary>
    public static void SetDownload<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> download) where T: IonTabButton
    {
        b.SetProperty(b.Const("download"), download);
    }
    ...
    /// Contains a URL or a URL fragment that the hyperlink points to. If this property is set, an anchor tag will be rendered.
    /// </summary>
    public static void SetHref<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> href) where T: IonTabButton
    {
        b.SetProperty(b.Const("href"), href);
    }
    ...
    /// Set the layout of the text and icon in the tab bar. It defaults to `"icon-top"`.
    /// </summary>
    public static void SetLayoutIconTop<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("layout"), b.Const("icon-top"));
    }
    ...
    /// Set the layout of the text and icon in the tab bar. It defaults to `"icon-top"`.
    /// </summary>
    public static void SetLayoutIconStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("layout"), b.Const("icon-start"));
    }
    ...
    /// Set the layout of the text and icon in the tab bar. It defaults to `"icon-top"`.
    /// </summary>
    public static void SetLayoutIconEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("layout"), b.Const("icon-end"));
    }
    ...
    /// Set the layout of the text and icon in the tab bar. It defaults to `"icon-top"`.
    /// </summary>
    public static void SetLayoutIconBottom<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("layout"), b.Const("icon-bottom"));
    }
    ...
    /// Set the layout of the text and icon in the tab bar. It defaults to `"icon-top"`.
    /// </summary>
    public static void SetLayoutIconHide<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("layout"), b.Const("icon-hide"));
    }
    ...
    /// Set the layout of the text and icon in the tab bar. It defaults to `"icon-top"`.
    /// </summary>
    public static void SetLayoutLabelHide<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("layout"), b.Const("label-hide"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// Specifies the relationship of the target object to the link object. The value is a space-separated list of [link types](https://developer.mozilla.org/en-US/docs/Web/HTML/Link_types).
    /// </summary>
    public static void SetRel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> rel) where T: IonTabButton
    {
        b.SetProperty(b.Const("rel"), rel);
    }
    ...
    /// The selected tab component
    /// </summary>
    public static void SetSelected<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTabButton
    {
        b.SetProperty(b.Const("selected"), b.Const(true));
    }
    public static void SetSelected<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> selected) where T: IonTabButton
    {
        b.SetProperty(b.Const("selected"), selected);
    }
    ...
    /// A tab id must be provided for each `ion-tab`. It's used internally to reference the selected tab or by the router to switch between them.
    /// </summary>
    public static void SetTab<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> tab) where T: IonTabButton
    {
        b.SetProperty(b.Const("tab"), tab);
    }
    ...
    /// Specifies where to display the linked URL. Only applies when an `href` is provided. Special keywords: `"_blank"`, `"_self"`, `"_parent"`, `"_top"`.
    /// </summary>
    public static void SetTarget<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> target) where T: IonTabButton
    {
        b.SetProperty(b.Const("target"), target);
    }
}