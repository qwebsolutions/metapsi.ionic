...
public class IonTextarea
{
    ...
    public static partial class Method
    {
        ...
        /// </summary>
        [System.Obsolete("Use the typed methods on ObjBuilder<IonTextarea> instead")]
...
{
    /// <summary>
    /// Builds a "ion-textarea" HTML tag
    /// </summary>
    ...
    {
        return b.IonicTag("ion-textarea", children);
    }
    ...
    /// <summary>
    /// Builds a virtual "ion-textarea" node
    /// </summary>
    ...
    {
        b.SetProperty(b.Const("autoGrow"), b.Const(true));
    }
    ...
    {
        b.SetProperty(b.Const("autoGrow"), autoGrow);
    }
    ...
    {
        b.SetProperty(b.Const("cols"), cols);
    }
    ...
    {
        b.SetProperty(b.Const("rows"), rows);
    }
    ...
    {
        b.SetProperty(b.Const("wrap"), b.Const("off"));
    }
    ...
    {
        b.SetProperty(b.Const("wrap"), b.Const("soft"));
    }
    ...
    {
        b.SetProperty(b.Const("wrap"), b.Const("hard"));
    }
    ...
    /// Emitted when the input loses focus.
    /// </summary>
    public static void OnIonBlur<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<FocusEvent>>> action) where T: IonTextarea
    {
        b.SetProperty(b.Const("onionBlur"), b.Const(action));
    }
    ...
    /// The `ionChange` event is fired when the user modifies the textarea's value. Unlike the `ionInput` event, the `ionChange` event is fired when the element loses focus after its value has been modified.  This event will not emit when programmatically setting the `value` property.
    /// </summary>
    public static void OnIonChange<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<TextareaChangeEventDetail>>> action) where T: IonTextarea
    {
        b.SetProperty(b.Const("onionChange"), b.Const(action));
    }
    ...
    /// Emitted when the input has focus.
    /// </summary>
    public static void OnIonFocus<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<FocusEvent>>> action) where T: IonTextarea
    {
        b.SetProperty(b.Const("onionFocus"), b.Const(action));
    }
    ...
    /// The `ionInput` event is fired each time the user modifies the textarea's value. Unlike the `ionChange` event, the `ionInput` event is fired for each alteration to the textarea's value. This typically happens for each keystroke as the user types.  When `clearOnEdit` is enabled, the `ionInput` event will be fired when the user clears the textarea by performing a keydown event.
    /// </summary>
    public static void OnIonInput<T, TModel>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<Metapsi.Hyperapp.HyperType.Action<TModel, CustomEvent<TextareaInputEventDetail>>> action) where T: IonTextarea
    {
        b.SetProperty(b.Const("onionInput"), b.Const(action));
    }
}
public static partial class IonTextareaExtensions
{

    /// <summary>
    /// If `true`, the textarea container will grow and shrink based on the contents of the textarea.
    /// </summary>
    public static void SetAutoGrow<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("autoGrow"), b.Const(true));
    }
    public static void SetAutoGrow<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> autoGrow) where T: IonTextarea
    {
        b.SetProperty(b.Const("autoGrow"), autoGrow);
    }
    ...
    /// Indicates whether and how the text value should be automatically capitalized as it is entered/edited by the user. Available options: `"off"`, `"none"`, `"on"`, `"sentences"`, `"words"`, `"characters"`.
    /// </summary>
    public static void SetAutocapitalize<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> autocapitalize) where T: IonTextarea
    {
        b.SetProperty(b.Const("autocapitalize"), autocapitalize);
    }
    ...
    /// Sets the [`autofocus` attribute](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/autofocus) on the native input element.  This may not be sufficient for the element to be focused on page load. See [managing focus](/docs/developing/managing-focus) for more information.
    /// </summary>
    public static void SetAutofocus<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("autofocus"), b.Const(true));
    }
    public static void SetAutofocus<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> autofocus) where T: IonTextarea
    {
        b.SetProperty(b.Const("autofocus"), autofocus);
    }
    ...
    /// If `true`, the value will be cleared after focus upon edit.
    /// </summary>
    public static void SetClearOnEdit<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("clearOnEdit"), b.Const(true));
    }
    public static void SetClearOnEdit<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> clearOnEdit) where T: IonTextarea
    {
        b.SetProperty(b.Const("clearOnEdit"), clearOnEdit);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorPrimary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("primary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSecondary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("secondary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorTertiary<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("tertiary"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorSuccess<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("success"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorWarning<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("warning"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDanger<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("danger"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorLight<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("light"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorMedium<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("medium"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColorDark<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), b.Const("dark"));
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> color) where T: IonTextarea
    {
        b.SetProperty(b.Const("color"), color);
    }
    ...
    /// The visible width of the text control, in average character widths. If it is specified, it must be a positive integer.
    /// </summary>
    public static void SetCols<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> cols) where T: IonTextarea
    {
        b.SetProperty(b.Const("cols"), cols);
    }
    ...
    /// If `true`, a character counter will display the ratio of characters used and the total character limit. Developers must also set the `maxlength` property for the counter to be calculated correctly.
    /// </summary>
    public static void SetCounter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("counter"), b.Const(true));
    }
    public static void SetCounter<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> counter) where T: IonTextarea
    {
        b.SetProperty(b.Const("counter"), counter);
    }
    ...
    /// A callback used to format the counter text. By default the counter text is set to "itemLength / maxLength".  See https://ionicframework.com/docs/troubleshooting/runtime#accessing-this if you need to access `this` from within the callback.
    /// </summary>
    public static void SetCounterFormatter<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<System.Func<int, int, string>> counterFormatter) where T: IonTextarea
    {
        b.SetProperty(b.Const("counterFormatter"), counterFormatter);
    }
    ...
    /// Set the amount of time, in milliseconds, to wait to trigger the `ionInput` event after each keystroke.
    /// </summary>
    public static void SetDebounce<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> debounce) where T: IonTextarea
    {
        b.SetProperty(b.Const("debounce"), debounce);
    }
    ...
    /// If `true`, the user cannot interact with the textarea.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("disabled"), b.Const(true));
    }
    public static void SetDisabled<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> disabled) where T: IonTextarea
    {
        b.SetProperty(b.Const("disabled"), disabled);
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintEnter<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("enter"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintDone<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("done"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintGo<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("go"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintNext<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("next"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintPrevious<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("previous"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("search"));
    }
    ...
    /// A hint to the browser for which enter key to display. Possible values: `"enter"`, `"done"`, `"go"`, `"next"`, `"previous"`, `"search"`, and `"send"`.
    /// </summary>
    public static void SetEnterkeyhintSend<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("enterkeyhint"), b.Const("send"));
    }
    ...
    /// Text that is placed under the textarea and displayed when an error is detected.
    /// </summary>
    public static void SetErrorText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> errorText) where T: IonTextarea
    {
        b.SetProperty(b.Const("errorText"), errorText);
    }
    ...
    /// The fill for the item. If `"solid"` the item will have a background. If `"outline"` the item will be transparent with a border. Only available in `md` mode.
    /// </summary>
    public static void SetFillOutline<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("fill"), b.Const("outline"));
    }
    ...
    /// The fill for the item. If `"solid"` the item will have a background. If `"outline"` the item will be transparent with a border. Only available in `md` mode.
    /// </summary>
    public static void SetFillSolid<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("fill"), b.Const("solid"));
    }
    ...
    /// Text that is placed under the textarea and displayed when no error is detected.
    /// </summary>
    public static void SetHelperText<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> helperText) where T: IonTextarea
    {
        b.SetProperty(b.Const("helperText"), helperText);
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeEmail<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("email"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeTel<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("tel"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeUrl<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("url"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeSearch<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("search"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeNone<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("none"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeText<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("text"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeNumeric<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("numeric"));
    }
    ...
    /// A hint to the browser for which keyboard to display. Possible values: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.
    /// </summary>
    public static void SetInputmodeDecimal<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("inputmode"), b.Const("decimal"));
    }
    ...
    /// The visible label associated with the textarea.  Use this if you need to render a plaintext label.  The `label` property will take priority over the `label` slot if both are used.
    /// </summary>
    public static void SetLabel<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> label) where T: IonTextarea
    {
        b.SetProperty(b.Const("label"), label);
    }
    ...
    /// Where to place the label relative to the textarea. `"start"`: The label will appear to the left of the textarea in LTR and to the right in RTL. `"end"`: The label will appear to the right of the textarea in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the textarea when the textarea is focused or it has a value. Otherwise it will appear on top of the textarea. `"stacked"`: The label will appear smaller and above the textarea regardless even when the textarea is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementStart<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("start"));
    }
    ...
    /// Where to place the label relative to the textarea. `"start"`: The label will appear to the left of the textarea in LTR and to the right in RTL. `"end"`: The label will appear to the right of the textarea in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the textarea when the textarea is focused or it has a value. Otherwise it will appear on top of the textarea. `"stacked"`: The label will appear smaller and above the textarea regardless even when the textarea is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementEnd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("end"));
    }
    ...
    /// Where to place the label relative to the textarea. `"start"`: The label will appear to the left of the textarea in LTR and to the right in RTL. `"end"`: The label will appear to the right of the textarea in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the textarea when the textarea is focused or it has a value. Otherwise it will appear on top of the textarea. `"stacked"`: The label will appear smaller and above the textarea regardless even when the textarea is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementFixed<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("fixed"));
    }
    ...
    /// Where to place the label relative to the textarea. `"start"`: The label will appear to the left of the textarea in LTR and to the right in RTL. `"end"`: The label will appear to the right of the textarea in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the textarea when the textarea is focused or it has a value. Otherwise it will appear on top of the textarea. `"stacked"`: The label will appear smaller and above the textarea regardless even when the textarea is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementStacked<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("stacked"));
    }
    ...
    /// Where to place the label relative to the textarea. `"start"`: The label will appear to the left of the textarea in LTR and to the right in RTL. `"end"`: The label will appear to the right of the textarea in LTR and to the left in RTL. `"floating"`: The label will appear smaller and above the textarea when the textarea is focused or it has a value. Otherwise it will appear on top of the textarea. `"stacked"`: The label will appear smaller and above the textarea regardless even when the textarea is blurred or has no value. `"fixed"`: The label has the same behavior as `"start"` except it also has a fixed width. Long text will be truncated with ellipses ("...").
    /// </summary>
    public static void SetLabelPlacementFloating<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("labelPlacement"), b.Const("floating"));
    }
    ...
    /// This attribute specifies the maximum number of characters that the user can enter.
    /// </summary>
    public static void SetMaxlength<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> maxlength) where T: IonTextarea
    {
        b.SetProperty(b.Const("maxlength"), maxlength);
    }
    ...
    /// This attribute specifies the minimum number of characters that the user can enter.
    /// </summary>
    public static void SetMinlength<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> minlength) where T: IonTextarea
    {
        b.SetProperty(b.Const("minlength"), minlength);
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeIos<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("mode"), b.Const("ios"));
    }
    ...
    /// The mode determines which platform styles to use.
    /// </summary>
    public static void SetModeMd<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("mode"), b.Const("md"));
    }
    ...
    /// The name of the control, which is submitted with the form data.
    /// </summary>
    public static void SetName<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> name) where T: IonTextarea
    {
        b.SetProperty(b.Const("name"), name);
    }
    ...
    /// Instructional text that shows before the input has a value.
    /// </summary>
    public static void SetPlaceholder<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> placeholder) where T: IonTextarea
    {
        b.SetProperty(b.Const("placeholder"), placeholder);
    }
    ...
    /// If `true`, the user cannot modify the value.
    /// </summary>
    public static void SetReadonly<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("readonly"), b.Const(true));
    }
    public static void SetReadonly<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> @readonly) where T: IonTextarea
    {
        b.SetProperty(b.Const("readonly"), @readonly);
    }
    ...
    /// If `true`, the user must fill in a value before submitting a form.
    /// </summary>
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("required"), b.Const(true));
    }
    public static void SetRequired<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> required) where T: IonTextarea
    {
        b.SetProperty(b.Const("required"), required);
    }
    ...
    /// The number of visible text lines for the control.
    /// </summary>
    public static void SetRows<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<int> rows) where T: IonTextarea
    {
        b.SetProperty(b.Const("rows"), rows);
    }
    ...
    /// The shape of the textarea. If "round" it will have an increased border radius.
    /// </summary>
    public static void SetShapeRound<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("shape"), b.Const("round"));
    }
    ...
    /// If `true`, the element will have its spelling and grammar checked.
    /// </summary>
    public static void SetSpellcheck<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("spellcheck"), b.Const(true));
    }
    public static void SetSpellcheck<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<bool> spellcheck) where T: IonTextarea
    {
        b.SetProperty(b.Const("spellcheck"), spellcheck);
    }
    ...
    /// The value of the textarea.
    /// </summary>
    public static void SetValue<T>(this Metapsi.Syntax.ObjBuilder<T> b, Metapsi.Syntax.Var<string> value) where T: IonTextarea
    {
        b.SetProperty(b.Const("value"), value);
    }
    ...
    /// Indicates how the control wraps text.
    /// </summary>
    public static void SetWrapOff<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("wrap"), b.Const("off"));
    }
    ...
    /// Indicates how the control wraps text.
    /// </summary>
    public static void SetWrapSoft<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("wrap"), b.Const("soft"));
    }
    ...
    /// Indicates how the control wraps text.
    /// </summary>
    public static void SetWrapHard<T>(this Metapsi.Syntax.ObjBuilder<T> b) where T: IonTextarea
    {
        b.SetProperty(b.Const("wrap"), b.Const("hard"));
    }
    ...
    /// Returns the native `&lt;textarea&gt;` element used under the hood.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise<HTMLTextAreaElement>> getInputElement(this Metapsi.Syntax.ObjBuilder<IonTextarea> b)
    {
        return b.Call<Promise<HTMLTextAreaElement>>("getInputElement");
    }

    /// <summary>
    /// Sets focus on the native `textarea` in `ion-textarea`. Use this method instead of the global `textarea.focus()`.  See [managing focus](/docs/developing/managing-focus) for more information.
    /// </summary>
    public static Metapsi.Syntax.ObjBuilder<Promise> setFocus(this Metapsi.Syntax.ObjBuilder<IonTextarea> b)
    {
